...
- `.codetutor/plugins/` – плагины уровня проекта.
...
1. Глобальная конфигурация (`~/.config/opencode/codetutor.json`)
2. Конфигурация проекта (`codetutor.json`)
3. Глобальный каталог плагинов (`~/.config/opencode/plugins/`)
4. Каталог плагинов проекта (`.codetutor/plugins/`)
...
Уровни: `debug`, `info`, `warn`, `error`. Подробности см. в документации SDK](https://codetutor-docs.vercel.app/docs/sdk).
