...
`.codetutor/commands/test.md` oluştur:
...
codetutor işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.
...
- Proje başına: `.codetutor/commands/`
