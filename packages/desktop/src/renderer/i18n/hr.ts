export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije CodeTutor. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
