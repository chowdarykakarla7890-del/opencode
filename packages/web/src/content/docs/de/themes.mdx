...
Mit CodeTutor kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet CodeTutor das `codetutor`-Theme.
...
CodeTutor liefert mehrere eingebaute Themes mit.
...
- CodeTutor optisch ans Terminal anpassen wollen
...
CodeTutor unterstuetzt ein flexibles JSON-basiertes Theme-System.
...
3. **Projekt-Root-Verzeichnis** - Definiert in `<project-root>/.codetutor/themes/*.json`
4. **Aktuelles Arbeitsverzeichnis** - Definiert in `./.codetutor/themes/*.json`
