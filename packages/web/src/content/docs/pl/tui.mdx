...
codetutor zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie codetutor uruchamia TUI dla bieżącego katalogu.
...
Jest to oddzielny plik od `codetutor.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo CodeTutor czeka po naciśnięciu leader key. Domyślnie `2000`.
