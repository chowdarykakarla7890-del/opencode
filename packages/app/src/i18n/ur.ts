export const dict = {
  ...
  "desktop.menu.documentation": "CodeTutor دستاویزات",
  ...
  "desktop.menu.ariaLabel": "CodeTutor مینو",
  ...
  "desktop.recovery.loadFailed": "CodeTutor لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "CodeTutor ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "CodeTutor جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutor کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.codetutorMissing": "اس ڈسٹری بیوشن میں opencode انسٹال نہیں ہے",
  "desktop.wsl.error.codetutorCannotRun": "opencode انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.codetutorNotInstalled": "{{distro}} میں CodeTutor انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "CodeTutor کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.codetutor.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.codetutor.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.codetutorGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "CodeTutor کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور CodeTutor میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.codetutorZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور CodeTutor میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور CodeTutor میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "codetutor.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس CodeTutor سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "CodeTutor چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں CodeTutor چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "CodeTutor کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں CodeTutor کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں CodeTutor کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "CodeTutor کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor {{distro}} میں تیار ہے۔",
  "wsl.onboarding.codetutorReady": "CodeTutor تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں CodeTutor انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "CodeTutor انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ CodeTutor WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر CodeTutor کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "CodeTutor Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CodeTutor ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم CodeTutor ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (codetutor.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، CodeTutor ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "CodeTutor ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر CodeTutor سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "CodeTutor کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر CodeTutor کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا CodeTutor سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "CodeTutor کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "CodeTutor لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ CodeTutor کا تازہ ترین ورژن چلا رہے ہیں۔",
