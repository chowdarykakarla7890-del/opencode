...
codetutor su konumlari tarar:

- Proje konfigurasyonu: `.codetutor/skills/<name>/SKILL.md`
...
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.codetutor/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.
...
`.codetutor/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
`codetutor.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`codetutor.json` icinde):
