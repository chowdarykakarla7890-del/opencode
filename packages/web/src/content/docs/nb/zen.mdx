---
title: Zen
description: Utvalgt liste over modeller levert av CodeTutor.
---
...
OpenCode Zen er en liste over testede og verifiserte modeller levert av CodeTutor-teamet.

Zen fungerer som enhver annen leverandør i CodeTutor. Du logger inn på OpenCode Zen og får
...
OpenCode Zen fungerer som enhver annen leverandør i CodeTutor.
...
[modell-id](/docs/config/#models) i CodeTutor-konfigurasjonen din
...
Du vil kanskje legge merke til [lavprismodeller](/docs/config/#models), som Haiku, Nano eller Flash, i brukshistorikken din. CodeTutor bruker disse modellene til å generere økttitler.
...
- DeepSeek V4 Flash Free er tilgjengelig på CodeTutor i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på CodeTutor i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Hy3 Free er tilgjengelig på CodeTutor i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Laguna S 2.1 Free er tilgjengelig på CodeTutor i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på CodeTutor i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3.5 Lightning Free er tilgjengelig på CodeTutor i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på CodeTutor i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med CodeTutor også.
