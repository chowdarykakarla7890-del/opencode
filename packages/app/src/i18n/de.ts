...
export const dict = {
  ...
  "dialog.provider.codetutor.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.codetutor.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.codetutorGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in CodeTutor zu nutzen.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in CodeTutor zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in CodeTutor zu nutzen.",
  ...
  "dialog.plugins.empty": "In codetutor.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den CodeTutor-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "CodeTutor wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "CodeTutor in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "CodeTutor wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "CodeTutor in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie CodeTutor in {{distro}}.",
  "wsl.onboarding.updateOpencode": "CodeTutor aktualisieren",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor ist in {{distro}} bereit.",
  "wsl.onboarding.codetutorReady": "CodeTutor ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie CodeTutor in {{distro}}.",
  "wsl.onboarding.installOpencode": "CodeTutor installieren",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor CodeTutor einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann CodeTutor erneut.",
  ...
  "toast.update.description": "Eine neue Version von CodeTutor ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem CodeTutor-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (codetutor.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: CodeTutor unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "CodeTutor mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "CodeTutor enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "CodeTutor-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für CodeTutor ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie CodeTutor auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob CodeTutor dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von CodeTutor anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von CodeTutor automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "CodeTutor ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von CodeTutor wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "CodeTutor konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das CodeTutor-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "CodeTutor reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutor-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.codetutorMissing": "opencode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.codetutorCannotRun": "opencode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das CodeTutor-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "CodeTutor Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
