...
const TIPS: Tip[] = [
  ...
  "Create {highlight}codetutor.json{/highlight} for server settings, and {highlight}tui.json{/highlight} for TUI",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.codetutor/commands/{/highlight} for reusable prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.codetutor/agents/{/highlight} for specialized AI personas",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.codetutor/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.codetutor/plugins/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent CodeTutor from reading sensitive files",
  "Use {highlight}codetutor run{/highlight} for non-interactive scripting",
  "Use {highlight}codetutor --continue{/highlight} to resume the last session",
  "Use {highlight}codetutor run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}codetutor serve{/highlight} for headless API access to CodeTutor",
  "Use {highlight}codetutor run --attach{/highlight} to connect to a running server",
  "Run {highlight}codetutor upgrade{/highlight} to update to the latest version",
  "Run {highlight}codetutor auth list{/highlight} to see all configured providers",
  "Run {highlight}codetutor agent create{/highlight} for guided agent creation",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in {highlight}.codetutor/themes/{/highlight} directory",
  ...
  "Run {highlight}codetutor debug config{/highlight} to troubleshoot configuration",
