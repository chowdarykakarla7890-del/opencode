---
title: Zen
description: codetutor tarafından sağlanan seçilmiş modeller listesi.
---
...
OpenCode Zen, CodeTutor ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, CodeTutor'daki diğer sağlayıcılar gibi çalışır. OpenCode Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve CodeTutor kullanmak için buna ihtiyacınız yoktur.
...
OpenCode Zen, CodeTutor'daki diğer sağlayıcılar gibi çalışır.
...
CodeTutor yapılandırmanızdaki [model id](/docs/config/#models) `opencode/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `opencode/gpt-5.5` kullanırsınız.
...
Kullanım geçmişinizde Haiku, Nano veya Flash gibi [düşük maliyetli modeller](/docs/config/#models) görebilirsiniz. CodeTutor, oturum başlıklarını oluşturmak için bu modelleri kullanır.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için CodeTutor'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için CodeTutor'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Hy3 Free, sınırlı bir süre için CodeTutor'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Laguna S 2.1 Free, sınırlı bir süre için CodeTutor'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için CodeTutor'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3.5 Lightning Free, sınırlı bir süre için CodeTutor'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için CodeTutor'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca CodeTutor ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
