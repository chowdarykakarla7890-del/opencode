export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja CodeTutor",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać CodeTutor",
  "desktop.recovery.terminated": "Okno CodeTutor zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "CodeTutor nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować CodeTutor",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.codetutorMissing": "Program opencode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.codetutorCannotRun": "Program opencode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja CodeTutor została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.codetutor.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.codetutorGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Odwiedź ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CodeTutor.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku codetutor.json",
  ...
  "dialog.server.description": "Przełącz serwer CodeTutor, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie CodeTutor w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie CodeTutor w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj CodeTutor w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj CodeTutor w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim CodeTutor będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja CodeTutor ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu CodeTutor",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (codetutor.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: CodeTutor nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "CodeTutor zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer CodeTutor wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla CodeTutor",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd CodeTutor na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy CodeTutor ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw CodeTutor.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CodeTutor",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CodeTutor.",
