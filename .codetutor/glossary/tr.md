...
- PR #15835: https://github.com/chowdarykakarla7890-del/opencode/pull/15835

## Do Not Translate (Locale Additions)

- `CodeTutor` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `CodeTutor` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `CodeTutor` inside commands, URLs, package names, or code literals
