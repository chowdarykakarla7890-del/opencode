...
Kreiraj `.codetutor/commands/test.md`:
...
Možete dodati prilagođene komande kroz CodeTutor konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom CodeTutor [config](/docs/config):
...
- Po projektu: `.codetutor/commands/`
...
CodeTutor uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
