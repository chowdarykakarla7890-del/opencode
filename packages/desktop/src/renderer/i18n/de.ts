export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von CodeTutor wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
