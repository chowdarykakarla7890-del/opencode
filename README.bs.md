...
<p align="center">CodeTutor je open source AI agent za programiranje.</p>
<p align="center">
...
# Package manageri
npm i -g codetutor-ai@latest        # ili bun/pnpm/yarn
scoop install codetutor             # Windows
choco install codetutor             # Windows
brew install anomalyco/tap/codetutor # macOS i Linux (preporučeno, uvijek ažurno)
brew install codetutor              # macOS i Linux (zvanična brew formula, rjeđe se ažurira)
sudo pacman -S codetutor            # Arch Linux (Stable)
paru -S codetutor-bin               # Arch Linux (Latest from AUR)
mise use -g codetutor               # Bilo koji OS
nix run nixpkgs#codetutor           # ili github:anomalyco/codetutor za najnoviji dev branch
```
...
CodeTutor je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/chowdarykakarla7890-del/opencode/releases) ili sa [codetutor.ai/download](https://github.com/chowdarykakarla7890-del/opencode/releases).
...
1. `$CODETUTOR_INSTALL_DIR` - Prilagođeni instalacijski direktorij
2. `$XDG_BIN_DIR` - Putanja usklađena sa XDG Base Directory specifikacijom
3. `$HOME/bin` - Standardni korisnički bin direktorij (ako postoji ili se može kreirati)
4. `$HOME/.codetutor/bin` - Podrazumijevana rezervna lokacija
...
CodeTutor uključuje dva ugrađena agenta između kojih možeš prebacivati tasterom `Tab`.
...
Saznaj više o [agentima](https://codetutor-docs.vercel.app/docs/agents).

### Dokumentacija

Za više informacija o konfiguraciji CodeTutor-a, [**pogledaj dokumentaciju**](https://codetutor-docs.vercel.app/docs).

### Doprinosi

Ako želiš doprinositi CodeTutor-u, pročitaj [upute za doprinošenje](./CONTRIBUTING.md) prije slanja pull requesta.

### Gradnja na CodeTutor-u

Ako radiš na projektu koji je povezan s CodeTutor-om i koristi "codetutor" kao dio naziva, npr. "codetutor-dashboard" ili "codetutor-mobile", dodaj napomenu u svoj README da projekat nije napravio CodeTutor tim i da nije povezan s nama.

---

**Pridruži se našoj zajednici** [Discord](https://discord.gg/codetutor) | [X.com](https://x.com/codetutor)
