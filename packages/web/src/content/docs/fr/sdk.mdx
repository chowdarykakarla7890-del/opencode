...
Utilisez-le pour créer des intégrations et contrôler codetutor par programme.
...
Vous pouvez transmettre un objet de configuration pour personnaliser le comportement. L'instance récupère toujours votre `codetutor.json`, mais vous pouvez remplacer ou ajouter une configuration en ligne :
