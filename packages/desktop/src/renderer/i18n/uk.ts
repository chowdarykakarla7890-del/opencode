export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} CodeTutor завантажено. Бажаєте встановити її та перезапустити?",
