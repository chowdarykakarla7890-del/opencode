export const dict = {
  ...
  "dialog.provider.codetutor.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.codetutor.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.codetutorGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "CodeTutorn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja CodeTutorssa.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Avaa ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja CodeTutorssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja CodeTutorssa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään codetutor.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda CodeTutor-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan CodeTutora...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan CodeTutora kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään CodeTutora...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään CodeTutora kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä CodeTutor jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor on valmis jakelussa {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna CodeTutor jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutora ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin CodeTutor voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten CodeTutor uudelleen.",
  ...
  "toast.update.description": "CodeTutorn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä CodeTutor-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (codetutor.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että CodeTutor ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita CodeTutor-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda CodeTutorn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä CodeTutor näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö CodeTutor järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta CodeTutorn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun CodeTutor käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät CodeTutorn uusinta versiota.",
  ...
  "desktop.menu.documentation": "CodeTutor-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "CodeTutor-valikko",
  ...
  "desktop.recovery.loadFailed": "CodeTutorn lataaminen epäonnistui",
  "desktop.recovery.terminated": "CodeTutor-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "CodeTutor ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutorn asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.codetutorMissing": "opencodea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.codetutorCannotRun": "opencode on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutora ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CodeTutorn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "CodeTutor Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
