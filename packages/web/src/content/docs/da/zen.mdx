---
title: Zen
description: Udvalgt liste over modeller leveret af CodeTutor.
---
...
OpenCode Zen er en liste over testede og verificerede modeller leveret af CodeTutor-teamet.

Zen fungerer som enhver anden udbyder i CodeTutor. Du logger ind på OpenCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med CodeTutor.
:::
...
OpenCode Zen fungerer som enhver anden udbyder i CodeTutor.
...
[model id](/docs/config/#models) i din CodeTutor-konfiguration
...
Du vil måske bemærke [lavprismodeller](/docs/config/#models), såsom Haiku, Nano eller Flash, i din brugshistorik. CodeTutor bruger disse modeller til at generere sessionstitler.
...
- DeepSeek V4 Flash Free er tilgængelig på CodeTutor i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på CodeTutor i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Hy3 Free er tilgængelig på CodeTutor i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Laguna S 2.1 Free er tilgængelig på CodeTutor i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på CodeTutor i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3.5 Lightning Free er tilgængelig på CodeTutor i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på CodeTutor i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med CodeTutor også.
