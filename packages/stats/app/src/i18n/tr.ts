export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | CodeTutor Data",
  "app.description":
    "CodeTutor Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde CodeTutor Data logosu",
  ...
  "header.githubAria": "GitHub'da CodeTutor'a yıldız ver",
  "header.github": "GitHub",
  "header.tryCodeTutor": "CodeTutor'u dene",
  ...
  "footer.homeAria": "CodeTutor ana sayfası",
  ...
  "home.topModelsDescription": "CodeTutor Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz CodeTutor Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | CodeTutor Data",
  "lab.description":
    "CodeTutor Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son CodeTutor kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "CodeTutor'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son CodeTutor kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük CodeTutor token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | CodeTutor Data",
  "model.description":
    "{{model}} için CodeTutor Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda CodeTutor Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki CodeTutor Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki CodeTutor Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde CodeTutor Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son CodeTutor Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz CodeTutor Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük CodeTutor Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz CodeTutor Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama CodeTutor Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan CodeTutor Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen CodeTutor Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son CodeTutor Go token hacmine göre yakındaki modeller.",
