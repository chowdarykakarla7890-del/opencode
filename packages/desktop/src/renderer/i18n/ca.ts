export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'CodeTutor. Voleu instal·lar-la i reiniciar l'aplicació?",
