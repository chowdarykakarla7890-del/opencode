...
codetutor ile birden fazla yerleşik tema arasından seçim yapabilir, terminal temanıza uyum sağlayan bir tema kullanabilir veya kendi özel temanızı tanımlayabilirsiniz.

Varsayılan olarak codetutor kendi `codetutor` temasını kullanır.
...
codetutor birden fazla yerleşik temayla gelir.
...
3. **Proje kök dizini** - `<project-root>/.codetutor/themes/*.json`
4. **Geçerli çalışma dizini** - `./.codetutor/themes/*.json`
