...
Opret `.codetutor/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem CodeTutor-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din CodeTutor [config](/docs/config):
...
codetutor indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
