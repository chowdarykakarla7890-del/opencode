...
مع CodeTutor يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم CodeTutor سمتنا `codetutor`.
...
يأتي CodeTutor مع عدة سمات مدمجة.
...
- يريدون أن يطابق CodeTutor مظهر terminal لديهم
...
يدعم CodeTutor نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
3. **مجلد جذر المشروع** - معرّف في `<project-root>/.codetutor/themes/*.json`
4. **مجلد العمل الحالي** - معرّف في `./.codetutor/themes/*.json`
