...
- PR #13942: https://github.com/chowdarykakarla7890-del/opencode/pull/13942

## Do Not Translate (Locale Additions)

- `CodeTutor` (preserve casing in prose; keep `opencode` only when it is part of commands, package names, paths, or code)
- `OpenCode Zen`
- `CodeTutor CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `opencode` in prose when referring to the product name; use `CodeTutor`
