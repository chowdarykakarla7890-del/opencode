...
Crea `.codetutor/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di CodeTutor o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di CodeTutor:
...
- Per progetto: `.codetutor/commands/`
...
codetutor include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
