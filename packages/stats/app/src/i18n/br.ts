export const dict = {
  "app.title": "Ranking de uso de modelos de IA | CodeTutor Data",
  "app.description":
    "Explore o uso do CodeTutor Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do CodeTutor Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao CodeTutor no GitHub",
  "header.github": "GitHub",
  "header.tryCodeTutor": "Experimente o CodeTutor",
  ...
  "footer.homeAria": "Início do CodeTutor",
  ...
  "modal.title": "Newsletter do CodeTutor",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no CodeTutor Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do CodeTutor Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | CodeTutor Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no CodeTutor Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do CodeTutor.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no CodeTutor",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do CodeTutor",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do CodeTutor nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | CodeTutor Data",
  "model.description":
    "Veja dados de uso de {{model}} no CodeTutor Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no CodeTutor Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do CodeTutor Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do CodeTutor Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do CodeTutor Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do CodeTutor Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do CodeTutor Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do CodeTutor Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do CodeTutor Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do CodeTutor Go.",
  ...
  "model.geoDescription": "Tokens do modelo CodeTutor Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do CodeTutor Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do CodeTutor Go.",
