...
Úselo para crear integraciones y controlar codetutor mediante programación.
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `codetutor.json`, pero puede anular o agregar configuración en línea:
