export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af CodeTutor er blevet downloadet. Vil du installere den og genstarte?",
