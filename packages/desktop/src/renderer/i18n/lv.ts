export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko CodeTutor versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "CodeTutor versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
