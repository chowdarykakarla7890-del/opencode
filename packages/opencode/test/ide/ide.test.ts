...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CODETUTOR_CALLER", () => {
    process.env["CODETUTOR_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CODETUTOR_CALLER", () => {
    process.env["CODETUTOR_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CODETUTOR_CALLER", () => {
    process.env["CODETUTOR_CALLER"] = "unknown"
