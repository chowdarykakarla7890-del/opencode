export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de CodeTutor. ¿Quieres instalarla y reiniciar?",
