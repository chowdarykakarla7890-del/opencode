...
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/chowdarykakarla7890-del/opencode/issues/11948
    // sampling: {},
    // https://github.com/chowdarykakarla7890-del/opencode/issues/23066
    // elicitation: {},
    // https://github.com/chowdarykakarla7890-del/opencode/issues/2308
    roots: {},
    // https://github.com/chowdarykakarla7890-del/opencode/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "codetutor", version: InstallationVersion }, CLIENT_OPTIONS)
            ...
            if (isAuthError) {
              if (lastError.message.includes("registration") || lastError.message.includes("client_id")) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: codetutor mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))
