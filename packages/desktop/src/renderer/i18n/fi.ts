export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo CodeTutorn uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "CodeTutorn versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää CodeTutorn uudelleen?",
