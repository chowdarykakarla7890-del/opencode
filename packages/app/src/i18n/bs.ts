export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za CodeTutor",
  ...
  "desktop.menu.ariaLabel": "CodeTutor meni",
  ...
  "desktop.recovery.loadFailed": "CodeTutor se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor CodeTutor-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "CodeTutor ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija CodeTutor-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.codetutorMissing": "opencode nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.codetutorCannotRun": "opencode je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje CodeTutor-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.codetutor.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.codetutorGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u CodeTutor-u.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Posjeti ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u CodeTutor-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u CodeTutor-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u codetutor.json",
  ...
  "dialog.server.description": "Promijeni na koji se CodeTutor server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera CodeTutor u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje CodeTutor u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj CodeTutor u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj CodeTutor u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi CodeTutor mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija CodeTutor-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku CodeTutor timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (codetutor.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: CodeTutor još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni CodeTutor server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u CodeTutor-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako CodeTutor izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li CodeTutor prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu CodeTutor-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se CodeTutor pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju CodeTutor-a.",
