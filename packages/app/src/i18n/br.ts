export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do CodeTutor",
  ...
  "desktop.menu.ariaLabel": "Menu do CodeTutor",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o CodeTutor",
  "desktop.recovery.terminated": "A janela do CodeTutor foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O CodeTutor não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do CodeTutor",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.codetutorMissing": "O opencode não está instalado nesta distribuição",
  "desktop.wsl.error.codetutorCannotRun": "O opencode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.codetutorNotInstalled": "O CodeTutor não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do CodeTutor foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.codetutor.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.codetutorGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Visite ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no CodeTutor.",
  ...
  "dialog.plugins.empty": "Plugins configurados em codetutor.json",
  ...
  "dialog.server.description": "Trocar para qual servidor CodeTutor este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o CodeTutor em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o CodeTutor em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o CodeTutor em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "O CodeTutor está pronto em {{distro}}.",
  "wsl.onboarding.codetutorReady": "O CodeTutor está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o CodeTutor em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o CodeTutor possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O CodeTutor não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o CodeTutor novamente.",
  ...
  "help.tabs.introduction": "Agora, o CodeTutor Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do CodeTutor ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do CodeTutor",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (codetutor.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: CodeTutor ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor CodeTutor dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do CodeTutor",
  ...
  "settings.general.row.appearance.description": "Personalize como o CodeTutor aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o CodeTutor segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o CodeTutor é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o CodeTutor iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do CodeTutor.",
