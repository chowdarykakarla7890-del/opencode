...
opencode'u ACP aracılığıyla kullanmak için düzenleyicinizi `codetutor acp` komutunu çalıştıracak şekilde yapılandırın.
...
Açmak için AI Chat agent seçicisindeki yeni 'CodeTutor' ajanını kullanın.
...
- codetutor yapılandırmanızda yapılandırılmış MCP sunucuları
