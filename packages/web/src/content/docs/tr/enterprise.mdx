...
:::note
codetutor kodunuzu veya içerik verilerinizi saklamaz.
:::
...
codetutor açık kaynaktır ve herhangi bir kodunuzu veya içerik verilerinizi saklamaz; böylece geliştiricileriniz [hemen başlayıp](/docs/) bir deneme gerçekleştirebilir.
...
Bir kullanıcı `/share` özelliğini etkinleştirirse, görüşme ve onunla ilişkili veriler, bu paylaşım sayfalarını codetutor-docs.vercel.app'de barındırmak için kullandığımız hizmete gönderilir.
...
**codetutor tarafından üretilen tüm kodlara sahipsiniz.** Herhangi bir lisans kısıtlaması veya mülkiyet iddiası yoktur.
...
Merkezi yapılandırmayla codetutor yalnızca dahili AI ağ geçidinizi kullanacak şekilde de yapılandırılabilir.
...
Ekibinizle dahili bir denemeyle başlayın. codetutor varsayılan olarak kodunuzu veya içerik verilerinizi saklamaz, bu da başlamayı kolaylaştırır.
...
Evet. codetutor kodunuzu veya içerik verilerinizi saklamaz. Tüm işlemler yerel olarak veya AI sağlayıcınıza doğrudan API çağrıları yoluyla gerçekleşir. Merkezi yapılandırma ve SSO entegrasyonuyla verileriniz kuruluşunuzun altyapısında güvende kalır.
...
Bu, kimlik doğrulama ayrıntılarını içeren `~/.npmrc` öğesini oluşturur. codetutor otomatik olarak
bunu alır.
