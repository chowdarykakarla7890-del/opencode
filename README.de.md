...
# Paketmanager
npm i -g codetutor-ai@latest        # oder bun/pnpm/yarn
scoop install codetutor             # Windows
choco install codetutor             # Windows
brew install anomalyco/tap/codetutor # macOS und Linux (empfohlen, immer aktuell)
brew install codetutor              # macOS und Linux (offizielle Brew-Formula, seltener aktualisiert)
sudo pacman -S codetutor            # Arch Linux (Stable)
paru -S codetutor-bin               # Arch Linux (Latest from AUR)
mise use -g codetutor               # jedes Betriebssystem
nix run nixpkgs#codetutor           # oder github:anomalyco/codetutor für den neuesten dev-Branch
```
...
CodeTutor ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/chowdarykakarla7890-del/opencode/releases) oder [codetutor.ai/download](https://github.com/chowdarykakarla7890-del/opencode/releases) herunter.
...
1. `$CODETUTOR_INSTALL_DIR` - Benutzerdefiniertes Installationsverzeichnis
2. `$XDG_BIN_DIR` - XDG Base Directory Specification-konformer Pfad
3. `$HOME/bin` - Standard-Binärverzeichnis des Users (falls vorhanden oder erstellbar)
4. `$HOME/.codetutor/bin` - Standard-Fallback
...
CodeTutor enthält zwei eingebaute Agents, zwischen denen du mit der `Tab`-Taste wechseln kannst.
...
Mehr dazu unter [Agents](https://codetutor-docs.vercel.app/docs/agents).

### Dokumentation

Mehr Infos zur Konfiguration von CodeTutor findest du in unseren [**Docs**](https://codetutor-docs.vercel.app/docs).

### Beitragen

Wenn du zu CodeTutor beitragen möchtest, lies bitte unsere [Contributing Docs](./CONTRIBUTING.md), bevor du einen Pull Request einreichst.

### Auf CodeTutor aufbauen

Wenn du an einem Projekt arbeitest, das mit CodeTutor zusammenhängt und "codetutor" als Teil seines Namens verwendet (z.B. "codetutor-dashboard" oder "codetutor-mobile"), füge bitte einen Hinweis in deine README ein, dass es nicht vom CodeTutor-Team gebaut wird und nicht in irgendeiner Weise mit uns verbunden ist.

---

**Tritt unserer Community bei** [Discord](https://discord.gg/codetutor) | [X.com](https://x.com/codetutor)
