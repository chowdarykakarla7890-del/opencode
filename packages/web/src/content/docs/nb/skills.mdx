...
Agentferdigheter lar CodeTutor oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går codetutor opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
codetutor viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `codetutor.json`:
