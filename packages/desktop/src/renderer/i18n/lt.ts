export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią CodeTutor versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "CodeTutor versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
