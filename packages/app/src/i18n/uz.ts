export const dict = {
  ...
  "desktop.menu.documentation": "CodeTutor hujjatlari",
  ...
  "desktop.menu.ariaLabel": "CodeTutor menyusi",
  ...
  "desktop.recovery.loadFailed": "CodeTutor yuklanmadi",
  "desktop.recovery.terminated": "CodeTutor oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "CodeTutor javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutor oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.codetutorMissing": "Opencode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.codetutorCannotRun": "opencode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "CodeTutor yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.codetutor.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.codetutorGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "CodeTutor tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va CodeTutor’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va CodeTutor da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va CodeTutor da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "codetutor.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi CodeTutor serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "CodeTutor tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "CodeTutor {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "CodeTutor yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "CodeTutor {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "CodeTutor-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "CodeTutor-ni yangilang",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor {{distro}} da tayyor.",
  "wsl.onboarding.codetutorReady": "CodeTutor tayyor.",
  "wsl.onboarding.installOpencodeIn": "CodeTutor-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "CodeTutor-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CodeTutor WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra CodeTutor-ni qayta oching.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CodeTutor ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida CodeTutor jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (codetutor.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, CodeTutor hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "CodeTutor bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi CodeTutor serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "CodeTutor uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "CodeTutor qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "CodeTutor tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "CodeTutor mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "CodeTutor ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz CodeTutor oxirgi versiyasini ishga tushiryapsiz.",
