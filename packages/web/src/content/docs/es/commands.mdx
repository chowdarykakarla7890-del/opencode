...
Crear `.codetutor/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración CodeTutor o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su CodeTutor [config](/docs/config):
...
- Por proyecto: `.codetutor/commands/`
...
codetutor incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
