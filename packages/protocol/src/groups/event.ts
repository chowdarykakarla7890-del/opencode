...
export const CodeTutorEvent = event.schema
export type CodeTutorEvent = typeof CodeTutorEvent.Type
export type CodeTutorEventEncoded = typeof CodeTutorEvent.Encoded
