export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด CodeTutor ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง CodeTutor หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "CodeTutor ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installOpencode": "การติดตั้ง CodeTutor ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.codetutorMissing": "ไม่ได้ติดตั้ง opencode ในดิสโทรนี้",
  "desktop.wsl.error.codetutorCannotRun": "ติดตั้ง opencode แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.codetutorNotInstalled": "ไม่ได้ติดตั้ง CodeTutor ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต CodeTutor เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.provider.codetutor.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.codetutor.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.codetutorGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน CodeTutor",
  ...
  "provider.connect.codetutorZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " เพื่อรับคีย์ API ของคุณ",
  "provider.connect.oauth.code.visit.prefix": "เยี่ยมชม ",
  "provider.connect.oauth.code.visit.link": "ลิงก์นี้",
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน CodeTutor",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน CodeTutor",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน codetutor.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ CodeTutor ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ CodeTutor ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต CodeTutor ใน {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต CodeTutor ใน {{distro}}",
  "wsl.onboarding.updateOpencode": "อัปเดต CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.codetutorReady": "CodeTutor พร้อมใช้งานแล้ว",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง CodeTutor ใน {{distro}}",
  "wsl.onboarding.installOpencode": "ติดตั้ง CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "ยังไม่ได้ติดตั้ง CodeTutor",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ CodeTutor จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด CodeTutor อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ CodeTutor Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ CodeTutor ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม CodeTutor",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (codetutor.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า CodeTutor ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ CodeTutor ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ CodeTutor",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ CodeTutor บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ CodeTutor ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ CodeTutor",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ CodeTutor เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน CodeTutor เวอร์ชันล่าสุด",
