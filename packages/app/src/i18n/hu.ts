...
const desktop = [
  ...
  "Kilépés",
  "Az CodeTutor betöltése sikertelen",
  "Az CodeTutor ablaka váratlanul leállt",
  "Az CodeTutor nem válaszol",
  ...
  "Az CodeTutor telepítése sikertelen",
  ...
  "Az CodeTutor nincs telepítve ebben: {{distro}}",
  "Az CodeTutor frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.codetutor.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.codetutor.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.codetutorGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A CodeTutor ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a CodeTutor-ben.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Látogatás",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a CodeTutor-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a CodeTutor-ben.",
  ...
  "dialog.plugins.empty": "Az codetutor.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik CodeTutor szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpencode": "CodeTutor ellenőrzése...",
  "wsl.onboarding.checkingOpencodeIn": "CodeTutor ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingOpencode": "CodeTutor frissítése...",
  "wsl.onboarding.updatingOpencodeIn": "CodeTutor frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateOpencodeIn": "Frissítse a CodeTutor-t a {{distro}}-ben.",
  "wsl.onboarding.updateOpencode": "Frissítse a CodeTutor-t",
  "wsl.onboarding.codetutorReadyIn": "A CodeTutor készen áll a {{distro}}-ben.",
  "wsl.onboarding.codetutorReady": "A CodeTutor készen áll.",
  "wsl.onboarding.installOpencodeIn": "Telepítse a CodeTutor-t a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse a CodeTutor-t",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "A CodeTutor nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a CodeTutor hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A CodeTutor nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a CodeTutor programot.",
  ...
  "help.tabs.introduction": "A CodeTutor Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A CodeTutor ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a CodeTutor csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (codetutor.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a CodeTutor még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A CodeTutor ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "CodeTutor asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a CodeTutor szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a CodeTutor kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a CodeTutor az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a CodeTutor a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a CodeTutor témáját.",
  ...
  "settings.updates.row.startup.description": "A CodeTutor indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a CodeTutor legújabb verzióját futtatja.",
