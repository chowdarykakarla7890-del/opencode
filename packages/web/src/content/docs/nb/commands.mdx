...
Opprett `.codetutor/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom CodeTutor-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i CodeTutor [config](/docs/config):
...
- Per prosjekt: `.codetutor/commands/`
...
CodeTutor inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
