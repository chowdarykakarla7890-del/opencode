import { CodeTutor } from "@opencode-ai/client/effect"
...
export const create = Effect.fn("CodeTutor.create")(function* () {
  ...
  const client = yield* CodeTutor.make({ baseUrl: "http://codetutor.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@opencode-ai/sdk-next/CodeTutor") {}
