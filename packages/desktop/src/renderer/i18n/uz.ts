export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon CodeTutor ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "CodeTutorning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
