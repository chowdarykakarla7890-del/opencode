...
# Pakkehåndteringer
npm i -g codetutor-ai@latest        # eller bun/pnpm/yarn
scoop install codetutor             # Windows
choco install codetutor             # Windows
brew install anomalyco/tap/codetutor # macOS og Linux (anbefalet, altid up to date)
brew install codetutor              # macOS og Linux (officiel brew formula, opdateres sjældnere)
sudo pacman -S codetutor            # Arch Linux (Stable)
paru -S codetutor-bin               # Arch Linux (Latest from AUR)
mise use -g codetutor               # alle OS
nix run nixpkgs#codetutor           # eller github:anomalyco/codetutor for nyeste dev-branch
```
...
CodeTutor findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/chowdarykakarla7890-del/opencode/releases) eller [codetutor.ai/download](https://github.com/chowdarykakarla7890-del/opencode/releases).
...
1. `$CODETUTOR_INSTALL_DIR` - Tilpasset installationsmappe
...
CodeTutor har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Læs mere om [agents](https://codetutor-docs.vercel.app/docs/agents).

### Dokumentation

For mere info om konfiguration af CodeTutor, [**se vores docs**](https://codetutor-docs.vercel.app/docs).

### Bidrag

Hvis du vil bidrage til CodeTutor, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på CodeTutor

Hvis du arbejder på et projekt der er relateret til CodeTutor og bruger "codetutor" som en del af navnet; f.eks. "codetutor-dashboard" eller "codetutor-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af CodeTutor-teamet og ikke er tilknyttet os på nogen måde.

---

**Bliv en del af vores community** [Discord](https://discord.gg/codetutor) | [X.com](https://x.com/codetutor)
