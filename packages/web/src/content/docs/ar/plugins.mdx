---
title: الإضافات
description: اكتب إضافاتك الخاصة لتوسيع CodeTutor.
---

تتيح لك الإضافات توسيع CodeTutor عبر ربطها بأحداث مختلفة وتخصيص السلوك. يمكنك إنشاء إضافات لإضافة ميزات جديدة، أو التكامل مع خدمات خارجية، أو تعديل السلوك الافتراضي لـ CodeTutor.
...
- `.codetutor/plugins/` - إضافات على مستوى المشروع
...
1. إعدادات عامة (`~/.config/opencode/codetutor.json`)
2. إعدادات المشروع (`codetutor.json`)
3. دليل الإضافات العام (`~/.config/opencode/plugins/`)
4. دليل إضافات المشروع (`.codetutor/plugins/`)
...
يشغّل CodeTutor الأمر `bun install` عند بدء التشغيل لتثبيتها. بعد ذلك يمكن لإضافاتك وأدواتك استيرادها.
...
:::note
إذا كنت تستخدم تطبيق CodeTutor لسطح المكتب، فيمكنه إرسال إشعارات النظام تلقائيا عند جاهزية الرد أو عند حدوث خطأ في جلسة.
:::
...
المستويات: `debug`, `info`, `warn`, `error`. راجع [توثيق SDK](https://codetutor-docs.vercel.app/docs/sdk) للتفاصيل.
