...
Use this folder for locale-specific translation guidance that supplements `.codetutor/agent/translator.md`.
...
- PR #12345: https://github.com/chowdarykakarla7890-del/opencode/pull/12345

## Do Not Translate (Locale Additions)

- `CodeTutor` (preserve casing)
