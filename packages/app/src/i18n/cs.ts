export const dict = {
  ...
  "desktop.menu.documentation": "CodeTutor Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka CodeTutor",
  ...
  "desktop.recovery.loadFailed": "CodeTutor se nepodařilo načíst",
  "desktop.recovery.terminated": "CodeTutor okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "CodeTutor nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutor instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.codetutorMissing": "opencode není v této distribuci nainstalováno",
  "desktop.wsl.error.codetutorCannotRun": "opencode je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CodeTutor aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.codetutor.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.codetutorGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Návštěva ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v CodeTutor.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v codetutor.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému CodeTutor serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola CodeTutor v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace CodeTutor v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace CodeTutor v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor je připraveno v {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte CodeTutor do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než CodeTutor může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze CodeTutor ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu CodeTutor",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (codetutor.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: CodeTutor zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server CodeTutor uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro CodeTutor",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled CodeTutor na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude CodeTutor následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma CodeTutor.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění CodeTutor",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi CodeTutor.",
