...
O codetutor usa o [AI SDK](https://ai-sdk.dev/) e [Models.dev](https://models.dev) para suportar **75+ provedores LLM** e suporta a execução de modelos locais.
...
Muitos modelos suportam várias variantes com diferentes configurações. O codetutor vem com variantes padrão integradas para provedores populares.

### Variantes integradas

O codetutor vem com variantes padrão para muitos provedores:
