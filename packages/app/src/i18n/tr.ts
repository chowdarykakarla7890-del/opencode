...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "CodeTutor yüklenemedi",
  "desktop.recovery.terminated": "CodeTutor penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "CodeTutor yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutor kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.codetutorMissing": "opencode bu dağıtımda kurulu değil",
  "desktop.wsl.error.codetutorCannotRun": "opencode kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "CodeTutor güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.codetutor.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.codetutorGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "CodeTutor tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve CodeTutor'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.codetutorZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak CodeTutor'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak CodeTutor'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler codetutor.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi CodeTutor sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "CodeTutor kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde CodeTutor kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "CodeTutor güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde CodeTutor güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki CodeTutor'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "CodeTutor'u güncelle",
  "wsl.onboarding.codetutorReadyIn": "{{distro}} içinde CodeTutor hazır.",
  "wsl.onboarding.codetutorReady": "CodeTutor hazır.",
  "wsl.onboarding.installOpencodeIn": "CodeTutor'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "CodeTutor'u kur",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CodeTutor'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından CodeTutor'u tekrar açın.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CodeTutor'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı CodeTutor ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (codetutor.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: CodeTutor henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "CodeTutor Masaüstü",
  ...
  "settings.desktop.wsl.description": "CodeTutor sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "CodeTutor'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "CodeTutor'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "CodeTutor'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "CodeTutor'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "CodeTutor başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "CodeTutor'un en son sürümünü kullanıyorsunuz.",
