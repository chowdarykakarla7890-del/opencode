---
title: Supporto ACP
description: Usa CodeTutor in qualunque editor compatibile con ACP.
---

CodeTutor supporta [Agent Client Protocol](https://agentclientprotocol.com) (ACP), permettendoti di usarlo direttamente in editor e IDE compatibili.
...
Per usare CodeTutor via ACP, configura l'editor in modo che esegua il comando `codetutor acp`.

Il comando avvia CodeTutor come sottoprocesso compatibile con ACP che comunica con l'editor via JSON-RPC su stdio.
...
Per aprirlo, seleziona il nuovo agente 'CodeTutor' nel selettore agenti di AI Chat.
...
Per usare CodeTutor come agente ACP in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), aggiungi quanto segue alla config di Neovim:
...
Questa config imposta CodeCompanion per usare CodeTutor come agente ACP per la chat.
...
CodeTutor funziona via ACP come nel terminale. Tutte le funzionalita sono supportate:
:::note
...
- Server MCP configurati nella tua configurazione CodeTutor
