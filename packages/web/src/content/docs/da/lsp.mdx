---
title: LSP-servere
description: CodeTutor integreres med dine LSP-servere.
---

CodeTutor kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

CodeTutor leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `CODETUTOR_DISABLE_LSP_DOWNLOAD` til `true`.
:::
