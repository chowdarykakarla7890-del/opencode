---
title: IDE
description: Rozszerzenie codetutor dla VS Code, Cursor i innych IDE
---

codetutor integruje się z VS Code, Cursorem lub obsługującym terminal IDE. Aby uruchomić, po prostu uruchom `codetutor` w terminalu.

---

## Stosowanie

- **Szybkie uruchomienie**: użycie `Cmd+Esc` (Mac) lub `Ctrl+Esc` (Windows/Linux), aby uruchomić codetutor w uruchamianiu terminala lub skoncentruj się na uruchamianiu terminala, jeśli jest już uruchomiony.
- **Nowa sesja**: `Cmd+Shift+Esc` (Mac) lub `Ctrl+Shift+Esc` (Windows/Linux), aby została nowa konfiguracja terminala opencode, nawet jeśli jest już otwarta. Możesz także kliknąć przycisk codetutor w interfejsie użytkownika.
...
Aby poznać codetutor na VS Code w forkach, takich jak Cursor, Windsurf, VSCodium:

1. Otwórz kod VS
2. Otwórz innowacyjny terminal
3. Uruchom `codetutor` — rozszerzenie instaluje się automatycznie
...
- zastosowanie się, że użycie `codetutor` w terminalu.
