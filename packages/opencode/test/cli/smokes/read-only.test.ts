...
describe("opencode read-only commands (smoke)", () => {
  ...
  // CODETUTOR_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh CODETUTOR_TEST_HOME means
  ...
  // in production it'd be a path under CODETUTOR_TEST_HOME / XDG_DATA_HOME.
