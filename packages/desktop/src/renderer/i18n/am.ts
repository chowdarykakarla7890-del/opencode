export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የCodeTutor ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከCodeTutor ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
