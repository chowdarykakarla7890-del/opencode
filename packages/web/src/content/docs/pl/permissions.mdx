...
codetutor używa `permission`, aby uniknąć, czy dana akcja została wykonana automatycznie, zachowana monit lub została zablokowana.
...
Uprawnienia codetutor są określane na podstawie nazwy narzędzia i kilku zabezpieczeń:
...
Jeżeli nic nie jest określone, codetutor zostanie uruchomione od dopuszczalnych rozwiązań diagnostycznych:
...
Gdy codetutor poprosi o zatwierdzenie, interfejs użytkownika oferujący trzy wyniki:
