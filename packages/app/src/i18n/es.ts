export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de CodeTutor",
  ...
  "desktop.menu.ariaLabel": "Menú de CodeTutor",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar CodeTutor",
  "desktop.recovery.terminated": "La ventana de CodeTutor se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "CodeTutor no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar CodeTutor",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.codetutorMissing": "opencode no está instalado en esta distribución",
  "desktop.wsl.error.codetutorCannotRun": "opencode está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de CodeTutor finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.codetutor.tagline": "Modelos optimizados y fiables",
  "dialog.provider.codetutorGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en CodeTutor.",
  ...
  "dialog.plugins.empty": "Plugins configurados en codetutor.json",
  ...
  "dialog.server.description": "Cambiar el servidor de CodeTutor al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando CodeTutor en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando CodeTutor en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza CodeTutor en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor está listo en {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala CodeTutor en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que CodeTutor pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de CodeTutor ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de CodeTutor",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (codetutor.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: CodeTutor aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor CodeTutor dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para CodeTutor",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve CodeTutor en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si CodeTutor sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de CodeTutor.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia CodeTutor",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de CodeTutor.",
