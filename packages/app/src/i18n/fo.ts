export const dict = {
  ...
  "desktop.menu.documentation": "CodeTutor Skjøl",
  ...
  "desktop.menu.ariaLabel": "CodeTutor valmynd",
  ...
  "desktop.recovery.loadFailed": "CodeTutor miseydnaðist at heinta",
  "desktop.recovery.terminated": "CodeTutor vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "CodeTutor svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutor uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.codetutorMissing": "opencode er ikki sett upp í hesi distro",
  "desktop.wsl.error.codetutorCannotRun": "opencode er sett upp men kundi ikki koyra",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CodeTutor dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.codetutor.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.codetutor.tagline": "Álítandi optimerað modell",
  "dialog.provider.codetutorGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Vitja ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í CodeTutor.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í codetutor.json",
  ...
  "dialog.server.description": "Skift hvønn CodeTutor ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna CodeTutor í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring CodeTutor í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør CodeTutor í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor er klárt í {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set CodeTutor upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn CodeTutor kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani CodeTutor aftur.",
  ...
  "help.tabs.introduction": "CodeTutor Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av CodeTutor ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til CodeTutor toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (codetutor.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, CodeTutor stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "CodeTutor Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr CodeTutor ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri CodeTutor",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu CodeTutor sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um CodeTutor fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu CodeTutor er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá CodeTutor byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av CodeTutor.",
