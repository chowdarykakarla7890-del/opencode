export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от CodeTutor е изтеглена. Искате ли да я инсталирате и рестартирате?",
