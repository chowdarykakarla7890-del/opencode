export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} CodeTutor a fost descărcată. Vrei să o instalezi și să repornești?",
