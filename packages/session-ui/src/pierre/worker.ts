...
import { registerCodeTutorTheme } from "@opencode-ai/ui/context/marked-theme-register"

registerCodeTutorTheme()
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for CodeTutor, as I think 8 might be
