...
- Spill oversized model-facing tool text into globally unique files under CodeTutor's shared tool-output directory.
...
- Canonicalize ambient instruction traversal boundaries, honor `CODETUTOR_DISABLE_PROJECT_CONFIG`, and make non-empty aggregate updates explicitly supersede previously loaded instructions.
