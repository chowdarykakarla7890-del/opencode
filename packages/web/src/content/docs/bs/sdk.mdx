---
title: SDK
description: Type-safe JS klijent za codetutor server.
---
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `codetutor.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu codetutor instancu, mozete napraviti klijentsku instancu i povezati se na nju:
