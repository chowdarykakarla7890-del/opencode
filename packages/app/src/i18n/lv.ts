export const dict = {
  ...
  "desktop.menu.documentation": "CodeTutor dokumentācija",
  ...
  "desktop.menu.ariaLabel": "CodeTutor izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt CodeTutor",
  "desktop.recovery.terminated": "CodeTutor logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "CodeTutor neatbild",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutor instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.codetutorMissing": "opencode nav instalēts šajā distribūcijā",
  "desktop.wsl.error.codetutorCannotRun": "opencode ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CodeTutor atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.codetutor.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.codetutorGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Apmeklējiet",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus CodeTutor.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti codetutor.json",
  ...
  "dialog.server.description": "Mainiet, pie kura CodeTutor servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOpencode": "Pārbaudu CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Pārbaudu CodeTutor distribūcijā {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atjauninu CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Atjauninu CodeTutor distribūcijā {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atjauniniet CodeTutor distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atjauniniet CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor ir gatavs.",
  "wsl.onboarding.installOpencodeIn": "Instalējiet CodeTutor distribūcijā {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalējiet CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms CodeTutor var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet CodeTutor no jauna.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna CodeTutor versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu CodeTutor komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (codetutor.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, CodeTutor vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "CodeTutor darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist CodeTutor serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt CodeTutor saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā CodeTutor izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai CodeTutor sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet CodeTutor tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot CodeTutor",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko CodeTutor versiju.",
