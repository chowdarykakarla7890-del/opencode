...
أنشئ الملف `.codetutor/commands/test.md`:
...
يمكنك إضافة أوامر مخصصة عبر إعدادات CodeTutor أو بإنشاء ملفات Markdown داخل الدليل `commands/`.

---

### JSON

استخدم خيار `command` في [config](/docs/config) الخاص بـ CodeTutor:
