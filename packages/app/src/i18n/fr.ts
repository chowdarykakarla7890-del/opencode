export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'CodeTutor",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'CodeTutor",
  "desktop.recovery.terminated": "La fenêtre CodeTutor s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "CodeTutor ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'CodeTutor",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.codetutorMissing": "opencode n'est pas installé dans cette distribution",
  "desktop.wsl.error.codetutorCannotRun": "opencode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'CodeTutor est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.codetutor.tagline": "Modèles optimisés et fiables",
  "dialog.provider.codetutorGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Visitez ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans CodeTutor.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans codetutor.json",
  ...
  "dialog.server.description": "Changez le serveur CodeTutor auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'CodeTutor dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'CodeTutor dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour CodeTutor dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor est prêt dans {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez CodeTutor dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'CodeTutor puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'CodeTutor ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe CodeTutor",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (codetutor.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'CodeTutor ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "CodeTutor inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur CodeTutor dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour CodeTutor",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'CodeTutor sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si CodeTutor suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'CodeTutor.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'CodeTutor",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'CodeTutor.",
