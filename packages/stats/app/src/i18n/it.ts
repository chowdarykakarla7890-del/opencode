export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | CodeTutor Data",
  "app.description":
    "Esplora l'utilizzo di CodeTutor Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo CodeTutor Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a CodeTutor su GitHub",
  "header.github": "GitHub",
  "header.tryCodeTutor": "Prova CodeTutor",
  ...
  "footer.homeAria": "Home CodeTutor",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in CodeTutor Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di CodeTutor Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | CodeTutor Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in CodeTutor Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di CodeTutor.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in CodeTutor",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di CodeTutor",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token CodeTutor negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | CodeTutor Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in CodeTutor Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di CodeTutor Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo CodeTutor Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo CodeTutor Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di CodeTutor Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di CodeTutor Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di CodeTutor Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token CodeTutor Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di CodeTutor Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione CodeTutor Go.",
  ...
  "model.geoDescription": "Token del modello CodeTutor Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica CodeTutor Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token CodeTutor Go.",
