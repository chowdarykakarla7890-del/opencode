...
- Secondary audience: CodeTutor and other durable agent runtimes
...
CodeTutor and other durable runtimes need to own persistence, tool settlement,
...
CodeTutor should migrate to `generateTurn` / `streamTurn`, preserving its durable
