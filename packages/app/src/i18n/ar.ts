export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل CodeTutor",
  "desktop.recovery.terminated": "توقفت نافذة CodeTutor بشكل غير متوقع",
  "desktop.recovery.unresponsive": "CodeTutor لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت CodeTutor",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.codetutorMissing": "opencode غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.codetutorCannotRun": "opencode مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث CodeTutor، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.codetutor.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.codetutor.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.codetutorGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "قم بزيارة ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في CodeTutor.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في codetutor.json",
  ...
  "dialog.server.description": "تبديل خادم CodeTutor الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من CodeTutor في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث CodeTutor في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث CodeTutor في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor جاهز في {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت CodeTutor في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن CodeTutor من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على CodeTutor التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح CodeTutor.",
  ...
  "help.tabs.introduction": "أصبح CodeTutor Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من CodeTutor ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق CodeTutor",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (codetutor.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن CodeTutor لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن CodeTutor نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم CodeTutor داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ CodeTutor",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور CodeTutor على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان CodeTutor يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة CodeTutor.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل CodeTutor",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من CodeTutor.",
