---
title: OpenCode Zen
description: Optional third-party model provider supported by CodeTutor.
---
...
OpenCode Zen is an optional third-party model gateway supported by CodeTutor. It is operated independently of
CodeTutor; its account, billing, privacy, and availability are governed by the provider.

Zen works like any other provider in CodeTutor. You login to OpenCode Zen and get
...
:::tip
You can use any supported provider. OpenCode Zen is not required to use CodeTutor or its offline lessons.
:::
...
The provider addresses this in a few ways:

1. It tests a select group of models and works with their teams on how to
   best run them.
2. It works with providers to make sure these are being served
   correctly.
3. It benchmarks model/provider combinations and publishes a curated list.
...
OpenCode Zen works like any other provider in CodeTutor.
...
You may notice [low-cost models](/docs/config/#models), such as Haiku, Nano, or Flash, in your usage history. CodeTutor uses these models to generate session titles.
...
- DeepSeek V4 Flash Free is available on CodeTutor for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo-V2.5 Free is available on CodeTutor for a limited time. The team is using this time to collect feedback and improve the model.
- Hy3 Free is available on CodeTutor for a limited time. The team is using this time to collect feedback and improve the model.
- Laguna S 2.1 Free is available on CodeTutor for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on CodeTutor for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3.5 Lightning Free is available on CodeTutor for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on CodeTutor for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with CodeTutor as well.
