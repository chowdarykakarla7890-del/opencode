---
title: Zen
description: Lista seleccionada de modelos proporcionada por CodeTutor.
---
...
OpenCode Zen es una lista de modelos probados y verificados proporcionada por el equipo de CodeTutor.

Zen funciona como cualquier otro proveedor en CodeTutor. Inicias sesión en OpenCode Zen y obtienes
...
OpenCode Zen funciona como cualquier otro proveedor en CodeTutor.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de CodeTutor
...
Puede que notes [modelos de bajo costo](/docs/config/#models), como Haiku, Nano o Flash, en tu historial de uso. CodeTutor usa estos modelos para generar títulos de sesiones.
...
- DeepSeek V4 Flash Free está disponible en CodeTutor por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo-V2.5 Free está disponible en CodeTutor por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Hy3 Free está disponible en CodeTutor por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Laguna S 2.1 Free está disponible en CodeTutor por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Ultra Free está disponible en CodeTutor por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3.5 Lightning Free está disponible en CodeTutor por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en CodeTutor por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con CodeTutor.
