...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>CodeTutor | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="CodeTutor terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to CodeTutor. Please read on to learn the rules and restrictions that govern your use of
                CodeTutor&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("CodeTutor," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://codetutor-docs.vercel.app/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-opencode">What is CodeTutor?</h2>
              <p>
                CodeTutor is an AI-powered coding agent that helps you write, understand, and modify code using large
                ...
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, CodeTutor enables you to
              ...
              <p>
                ...
                our site located at codetutor-docs.vercel.app, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                CodeTutor takes the privacy of its users very seriously. For the current CodeTutor Privacy Policy, please
                click here{" "}
                <a href="https://codetutor-docs.vercel.app/legal/privacy-policy">https://codetutor-docs.vercel.app/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using CodeTutor?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by CodeTutor;
                </li>
                <li>
              ...
              <p>
                If you use CodeTutor with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                CodeTutor. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                CodeTutor has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-opencode-ever-change-the-services">Will CodeTutor ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://codetutor-docs.vercel.app/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://codetutor-docs.vercel.app/auth">https://codetutor-docs.vercel.app/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://codetutor-docs.vercel.app/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                CodeTutor is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. CodeTutor has the sole right to decide whether you are
              ...
              <p>
                CodeTutor and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (CodeTutor and all such
                parties together, the "CodeTutor Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the CodeTutor Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The CodeTutor Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the CodeTutor Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without CodeTutor's prior written
              ...
              <p>
                ...
                disputes and claims with CodeTutor and limits the manner in which you can seek relief from CodeTutor. Both
                you and CodeTutor acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, CodeTutor's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. CodeTutor will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. CodeTutor will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or CodeTutor may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and CodeTutor are instead choosing to have claims and disputes resolved by
                ...
                you and CodeTutor over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                CodeTutor is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or CodeTutor to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and CodeTutor agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the CodeTutor may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and CodeTutor agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and CodeTutor, and
                ...
                are not an employee, agent, partner, or joint venture of CodeTutor, and you do not have any authority of
                any kind to bind CodeTutor in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and CodeTutor
