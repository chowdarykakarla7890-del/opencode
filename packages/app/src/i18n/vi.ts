export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu CodeTutor",
  ...
  "desktop.recovery.loadFailed": "Không tải được CodeTutor",
  "desktop.recovery.terminated": "Cửa sổ CodeTutor đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "CodeTutor không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được CodeTutor",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.codetutorMissing": "opencode chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.codetutorCannotRun": "opencode đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật CodeTutor nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.codetutor.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.codetutorGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do CodeTutor cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Truy cập ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong CodeTutor.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong codetutor.json",
  ...
  "dialog.server.description": "Chuyển máy chủ CodeTutor mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra CodeTutor trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật CodeTutor trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật CodeTutor trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt CodeTutor trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi CodeTutor có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của CodeTutor ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm CodeTutor",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (codetutor.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: CodeTutor chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ CodeTutor bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho CodeTutor",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của CodeTutor trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem CodeTutor tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của CodeTutor.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi CodeTutor khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của CodeTutor.",
