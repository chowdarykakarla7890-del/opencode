...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða CodeTutor",
  "CodeTutor-glugganum var óvænt lokað",
  "CodeTutor svarar ekki",
  ...
  "CodeTutor er ekki uppsett í {{distro}}",
  "Uppfærslu CodeTutor lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.codetutor.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.codetutor.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.codetutorGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Heimsókn",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í CodeTutor.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í codetutor.json",
  ...
  "dialog.server.description": "Skiptu um hvaða CodeTutor miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar CodeTutor í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir CodeTutor í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu CodeTutor í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor er tilbúið í {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp CodeTutor í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en CodeTutor getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan CodeTutor aftur.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af CodeTutor ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til CodeTutor teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (codetutor.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, CodeTutor styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "CodeTutor inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "CodeTutor skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu CodeTutor netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir CodeTutor",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig CodeTutor lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort CodeTutor fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig CodeTutor er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar CodeTutor ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af CodeTutor.",
