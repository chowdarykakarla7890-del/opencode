---
title: Zen
description: Lista curata di modelli fornita da CodeTutor.
---
...
OpenCode Zen è un elenco di modelli testati e verificati forniti dal team di CodeTutor.

Zen funziona come qualsiasi altro provider in CodeTutor. Accedi a OpenCode Zen e ottieni
...
OpenCode Zen funziona come qualsiasi altro provider in CodeTutor.
...
Il [model id](/docs/config/#models) nella config di CodeTutor
...
Potresti notare [modelli a basso costo](/docs/config/#models), come Haiku, Nano o Flash, nella cronologia di utilizzo. CodeTutor usa questi modelli per generare i titoli delle sessioni.
...
- DeepSeek V4 Flash Free è disponibile su CodeTutor per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su CodeTutor per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Hy3 Free è disponibile su CodeTutor per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Laguna S 2.1 Free è disponibile su CodeTutor per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su CodeTutor per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3.5 Lightning Free è disponibile su CodeTutor per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su CodeTutor per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con CodeTutor.
