...
Les compétences d'agent permettent à CodeTutor de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
CodeTutor recherche ces emplacements :

- Configuration du projet : `.codetutor/skills/<name>/SKILL.md`
...
Pour les chemins locaux du projet, CodeTutor remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
Il charge tout `skills/*/SKILL.md` correspondant dans `.codetutor/` et tout `.claude/skills/*/SKILL.md` ou `.agents/skills/*/SKILL.md` correspondant en cours de route.
...
Créez `.codetutor/skills/git-release/SKILL.md` comme ceci :
...
CodeTutor répertorie les compétences disponibles dans la description de l'outil `skill`.
...
Contrôlez les compétences auxquelles les agents peuvent accéder à l'aide d'autorisations basées sur des modèles dans `codetutor.json` :
...
**Pour les agents intégrés** (dans `codetutor.json`) :
