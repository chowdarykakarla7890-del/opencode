export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} CodeTutor. Czy chcesz ją zainstalować i uruchomić ponownie?",
