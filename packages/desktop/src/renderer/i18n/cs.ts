export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace CodeTutor. Chcete ji nainstalovat a aplikaci znovu spustit?",
