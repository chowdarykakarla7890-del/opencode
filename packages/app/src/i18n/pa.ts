export const dict = {
  ...
  "desktop.menu.documentation": "CodeTutor دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "CodeTutor لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "CodeTutor دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "CodeTutor جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutor دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.codetutorMissing": "اس ڈسٹرو وچ opencode انسٹال نئیں اے",
  "desktop.wsl.error.codetutorCannotRun": "opencode انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.codetutorNotInstalled": "{{distro}} وچ CodeTutor انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "CodeTutor دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.codetutor.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.codetutor.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.codetutorGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "CodeTutor دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے CodeTutor وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.codetutorZen.visit.prefix": "ویکھو ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے CodeTutor وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے CodeTutor وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "codetutor.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس CodeTutor سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "CodeTutor چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ CodeTutor دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "CodeTutor نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ CodeTutor نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ CodeTutor نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "CodeTutor اپ ڈیٹ کرو",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor {{distro}} چ تیار اے۔",
  "wsl.onboarding.codetutorReady": "CodeTutor تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ CodeTutor انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "CodeTutor انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CodeTutor دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر CodeTutor دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "CodeTutor Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CodeTutor ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع CodeTutor ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (codetutor.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، CodeTutor ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر CodeTutor سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "CodeTutor لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے CodeTutor کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا CodeTutor سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "CodeTutor نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں CodeTutor لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی CodeTutor دا تازہ ترین ورژن چلا رئے او۔",
