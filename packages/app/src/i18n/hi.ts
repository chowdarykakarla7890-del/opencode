export const dict = {
  ...
  "desktop.menu.documentation": "CodeTutor दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "CodeTutor मेन्यू",
  ...
  "desktop.recovery.loadFailed": "CodeTutor लोड नहीं हो सका",
  "desktop.recovery.terminated": "CodeTutor विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "CodeTutor प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutor इंस्टॉल नहीं हो सका",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहले ही जोड़ा जा चुका है",
  "desktop.wsl.error.codetutorMissing": "इस डिस्ट्रो में opencode इंस्टॉल नहीं है",
  "desktop.wsl.error.codetutorCannotRun": "opencode इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.codetutorNotInstalled": "{{distro}} में CodeTutor इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "CodeTutor अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "dialog.provider.codetutor.note": "Claude, GPT, Gemini और अधिक सहित क्यूरेटेड मॉडल",
  "dialog.provider.codetutor.tagline": "विश्वसनीय अनुकूलित मॉडल",
  "dialog.provider.codetutorGo.tagline": "सभी के लिए कम लागत वाली सदस्यता",
  ...
  "dialog.model.unpaid.freeModels.title": "CodeTutor द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और CodeTutor में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.codetutorZen.line2": "एक API कुंजी से आपको Claude, GPT, Gemini, GLM जैसे कई मॉडलों तक पहुँच मिलेगी।",
  "provider.connect.codetutorZen.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " अपनी API कुंजी प्राप्त करने के लिए।",
  "provider.connect.oauth.code.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.oauth.code.visit.link": "इस लिंक",
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और CodeTutor में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा CodeTutor में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.plugins.empty": "प्लगइन codetutor.json में कॉन्फ़िगर किए गए हैं",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस CodeTutor सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpencode": "CodeTutor की जाँच हो रही है...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में CodeTutor की जाँच हो रही है...",
  "wsl.onboarding.updatingOpencode": "CodeTutor अपडेट हो रहा है...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में CodeTutor अपडेट हो रहा है...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में CodeTutor को अपडेट करें।",
  "wsl.onboarding.updateOpencode": "CodeTutor को अपडेट करें",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor {{distro}} में तैयार है।",
  "wsl.onboarding.codetutorReady": "CodeTutor तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में CodeTutor स्थापित करें।",
  "wsl.onboarding.installOpencode": "CodeTutor स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CodeTutor द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर CodeTutor को फिर से खोलें।",
  ...
  "help.tabs.introduction": "CodeTutor Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CodeTutor ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट CodeTutor टीम को करें",
  ...
  "error.chain.checkConfig": "अपने कॉन्फ़िगरेशन (codetutor.json) प्रोवाइडर/मॉडल नामों की जाँच करें",
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, CodeTutor अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर CodeTutor सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "CodeTutor के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि CodeTutor आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि CodeTutor सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि CodeTutor की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "CodeTutor लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप CodeTutor का नवीनतम संस्करण चला रहे हैं।",
