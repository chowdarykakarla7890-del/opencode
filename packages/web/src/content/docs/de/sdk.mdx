...
Damit kannst du Integrationen bauen und codetutor programmatisch steuern.
...
`codetutor.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn codetutor bereits laeuft, kannst du nur einen Client erstellen und verbinden:
