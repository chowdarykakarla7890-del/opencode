...
const desktopStateNames = ["com.codetutor.desktop.dev", "com.codetutor.desktop.beta", "com.codetutor.desktop"]
...
function executableName() {
  return process.platform === "win32" ? "codetutor-cli.exe" : "codetutor-cli"
}
