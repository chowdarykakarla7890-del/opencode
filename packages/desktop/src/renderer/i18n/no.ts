export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av CodeTutor er lastet ned. Vil du installere den og starte på nytt?",
