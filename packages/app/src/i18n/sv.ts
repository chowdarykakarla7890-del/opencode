export const dict = {
  ...
  "desktop.recovery.loadFailed": "CodeTutor kunde inte läsas in",
  "desktop.recovery.terminated": "CodeTutor-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "CodeTutor svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av CodeTutor misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.codetutorMissing": "opencode är inte installerat i den här distributionen",
  "desktop.wsl.error.codetutorCannotRun": "opencode är installerat men kunde inte köras",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CodeTutor-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.codetutor.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.codetutor.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.codetutorGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Besök ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i CodeTutor.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i codetutor.json",
  ...
  "dialog.server.description": "Växla vilken CodeTutor-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar CodeTutor i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar CodeTutor i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera CodeTutor i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor är redo i {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera CodeTutor i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan CodeTutor kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan CodeTutor igen.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av CodeTutor ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till CodeTutor-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (codetutor.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, CodeTutor stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör CodeTutor-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för CodeTutor",
  ...
  "settings.general.row.appearance.description": "Anpassa hur CodeTutor ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om CodeTutor följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa CodeTutors tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när CodeTutor startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av CodeTutor.",
