---
title: TUI
description: Brug af CodeTutor-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodeTutor giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre CodeTutor starter TUI for den nuværende mappe.
...
Når du bruger CodeTutor TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til CodeTutor. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut CodeTutor. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `codetutor.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe CodeTutor venter efter leader key. Standard er `2000`.
