export const dict = {
  ...
  "desktop.updater.none.message": "ທ່ານກຳລັງໃຊ້ CodeTutor ເວີຊັນຫຼ້າສຸດຢູ່ແລ້ວ",
  ...
  "desktop.updater.downloaded.prompt":
    "ເວີຊັນ {{version}} ຂອງ CodeTutor ໄດ້ຖືກດາວໂຫຼດແລ້ວ, ທ່ານຕ້ອງການຕິດຕັ້ງມັນ ແລະເປີດຄືນໃໝ່ບໍ?",
