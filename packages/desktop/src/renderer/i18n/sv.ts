export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av CodeTutor har laddats ned. Vill du installera den och starta om programmet?",
