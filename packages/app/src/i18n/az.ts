export const dict = {
  ...
  "desktop.recovery.loadFailed": "CodeTutor yüklənə bilmədi",
  "desktop.recovery.terminated": "CodeTutor pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "CodeTutor cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutor quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.codetutorMissing": "Bu distribütivdə opencode quraşdırılmayıb",
  "desktop.wsl.error.codetutorCannotRun": "opencode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "CodeTutor yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.codetutor.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.codetutorGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "CodeTutor tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və CodeTutor-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və CodeTutor-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və CodeTutor-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər codetutor.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu CodeTutor serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "CodeTutor yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də CodeTutor yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "CodeTutor yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də CodeTutor yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də CodeTutor-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "CodeTutor-u yeniləyin",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor {{distro}}-də hazırdır.",
  "wsl.onboarding.codetutorReady": "CodeTutor hazırdır.",
  "wsl.onboarding.installOpencodeIn": "CodeTutor-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "CodeTutor quraşdırın",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CodeTutor WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra CodeTutor-u yenidən açın.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CodeTutor-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı CodeTutor komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (codetutor.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: CodeTutor hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində CodeTutor serverini işlət.",
  ...
  "settings.general.row.language.description": "CodeTutor üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "CodeTutor-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "CodeTutor-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "CodeTutor-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "CodeTutor açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "CodeTutor-un ən son versiyasından istifadə edirsiniz.",
