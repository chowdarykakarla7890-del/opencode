...
const en = {
  "app.title": "AI Model Usage Rankings | CodeTutor Data",
  "app.description":
    "Explore CodeTutor Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "CodeTutor Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star CodeTutor on GitHub",
  "header.github": "GitHub",
  "header.tryCodeTutor": "Try CodeTutor",
  ...
  "footer.homeAria": "CodeTutor home",
  ...
  "home.topModelsDescription": "Usage of models across CodeTutor Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique CodeTutor Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | CodeTutor Data",
  "lab.description":
    "Compare {{lab}} models used in CodeTutor Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent CodeTutor usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in CodeTutor",
  ...
  "lab.shareOfUsage": "{{share}} of recent CodeTutor usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | CodeTutor Data",
  "model.description":
    "View {{model}} CodeTutor Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. CodeTutor Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's CodeTutor Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's CodeTutor Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No CodeTutor Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no CodeTutor Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "CodeTutor Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No CodeTutor Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent CodeTutor Go token volume.",
