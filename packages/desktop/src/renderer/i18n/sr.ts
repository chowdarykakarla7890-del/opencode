export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од CodeTutor је преузета, да ли желите да је инсталирате и поново покренете?",
