---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez CodeTutor.
---
...
OpenCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół CodeTutor.

Zen działa jak każdy inny dostawca w CodeTutor. Logujesz się do OpenCode Zen i otrzymujesz
...
OpenCode Zen działa jak każdy inny dostawca w CodeTutor.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji CodeTutor używa formatu
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. CodeTutor używa tych modeli do generowania tytułów sesji.
...
- DeepSeek V4 Flash Free jest dostępny w CodeTutor przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w CodeTutor przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Hy3 Free jest dostępny w CodeTutor przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Laguna S 2.1 Free jest dostępny w CodeTutor przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w CodeTutor przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3.5 Lightning Free jest dostępny w CodeTutor przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w CodeTutor przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w CodeTutor także dowolnego innego dostawcy.
