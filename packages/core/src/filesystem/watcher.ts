...
declare const CODETUTOR_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof CODETUTOR_LIBC === "undefined" ? undefined : CODETUTOR_LIBC
...
const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.CODETUTOR_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.CODETUTOR_EXPERIMENTAL_FILEWATCHER)) {
