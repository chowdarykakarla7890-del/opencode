...
description: Brug CodeTutor i enhver ACP-kompatibel editor.
---

CodeTutor understøtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), så du kan bruge det direkte i kompatible editorer og IDE'er.
...
For at bruge CodeTutor via ACP, konfigurer din editor til at køre kommandoen `codetutor acp`.

Kommandoen starter CodeTutor som en ACP-kompatibel underproces, der kommunikerer med din editor over JSON-RPC via stdio.
...
For at åbne den skal du bruge den nye 'CodeTutor'-agent i AI Chat-agentvælgeren.
...
For at bruge CodeTutor som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), skal du tilføje følgende til din Neovim-konfiguration:
...
Denne konfiguration sætter CodeCompanion til at bruge CodeTutor som ACP-agent til chat.
...
CodeTutor fungerer på samme måde via ACP som i terminalen. Alle funktioner understøtter:
...
- MCP-servere konfigureret i din CodeTutor-konfiguration
