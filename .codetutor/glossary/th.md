...
- PR #10809: https://github.com/chowdarykakarla7890-del/opencode/pull/10809
- PR #11496: https://github.com/chowdarykakarla7890-del/opencode/pull/11496

## Do Not Translate (Locale Additions)

- `CodeTutor` (preserve casing in prose; keep `opencode` only in commands, package names, paths, or code)
- `CodeTutor CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
