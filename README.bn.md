...
# Package managers
npm i -g codetutor-ai@latest        # or bun/pnpm/yarn
scoop install codetutor             # Windows
choco install codetutor             # Windows
brew install anomalyco/tap/codetutor # macOS and Linux (recommended, always up to date)
brew install codetutor              # macOS and Linux (official brew formula, updated less)
sudo pacman -S codetutor            # Arch Linux (Stable)
paru -S codetutor-bin               # Arch Linux (Latest from AUR)
mise use -g codetutor               # Any OS
nix run nixpkgs#codetutor           # or github:anomalyco/codetutor for latest dev branch
```
...
CodeTutor ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/chowdarykakarla7890-del/opencode/releases) অথবা [codetutor.ai/download](https://github.com/chowdarykakarla7890-del/opencode/releases) থেকে ডাউনলোড করুন।
...
1. `$CODETUTOR_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.codetutor/bin` - ডিফল্ট ফলব্যাক
...
CodeTutor এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://codetutor-docs.vercel.app/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে CodeTutor কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://codetutor-docs.vercel.app/docs)।

### অবদান (Contributing)

আপনি যদি CodeTutor এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### CodeTutor এর উপর বিল্ডিং (Building on CodeTutor)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা CodeTutor এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "codetutor" ব্যবহার করেন, উদাহরণস্বরূপ "codetutor-dashboard" বা "codetutor-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি CodeTutor দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/codetutor) | [X.com](https://x.com/codetutor)
