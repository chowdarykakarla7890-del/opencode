---
title: TUI
description: استخدام واجهة المستخدم TUI في CodeTutor.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر CodeTutor واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل CodeTutor إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة CodeTutor في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى CodeTutor. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من CodeTutor. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `codetutor.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار CodeTutor بعد الضغط على leader key. القيمة الافتراضية `2000`.
