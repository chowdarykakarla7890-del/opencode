export const dict = {
  ...
  "desktop.menu.documentation": "CodeTutor Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "CodeTutor μενού",
  ...
  "desktop.recovery.loadFailed": "CodeTutor απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "CodeTutor το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "CodeTutor δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutor η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.codetutorMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.codetutorCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CodeTutor η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Επιμελημένα μοντέλα συμπεριλαμβανομένων των Claude, GPT, Gemini και άλλων",
  "dialog.provider.codetutor.tagline": "Αξιόπιστα βελτιστοποιημένα μοντέλα",
  "dialog.provider.codetutorGo.tagline": "Συνδρομή χαμηλού κόστους για όλους",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο CodeTutor.",
  ...
  "provider.connect.codetutorZen.line1":
    "CodeTutor Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Επίσκεψη ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " για τη συλλογή του κλειδιού σας API.",
  "provider.connect.oauth.code.visit.prefix": "Επίσκεψη ",
  "provider.connect.oauth.code.visit.link": "αυτός ο σύνδεσμος",
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο CodeTutor.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο codetutor.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή CodeTutor συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος CodeTutor σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση CodeTutor σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση CodeTutor σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του CodeTutor στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο CodeTutor να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του CodeTutor ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα CodeTutor",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (codetutor.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το CodeTutor δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "CodeTutor Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή CodeTutor μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το CodeTutor",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του CodeTutor στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το CodeTutor ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το CodeTutor.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του CodeTutor",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του CodeTutor.",
