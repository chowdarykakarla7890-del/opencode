---
title: การรองรับ ACP
description: ใช้ CodeTutor ในโปรแกรมแก้ไขที่รองรับ ACP
---

CodeTutor รองรับ [Agent Client Protocol](https://agentclientprotocol.com) (ACP) ซึ่งช่วยให้สามารถทำงานร่วมกับ editor และ IDE ต่างๆ ได้โดยตรง
...
ในการใช้ CodeTutor ผ่าน ACP ให้กำหนดค่าโปรแกรมแก้ไขของคุณให้รันคำสั่ง `codetutor acp`

คำสั่งนี้จะเริ่ม CodeTutor เป็น process ย่อยที่รองรับ ACP ซึ่งสื่อสารกับโปรแกรมแก้ไขของคุณผ่าน JSON-RPC ทาง stdio
...
นี่เป็นการเปิดให้ตัวแทน 'CodeTutor' ในเนื้อหาของตัวแทน AI Chat
...
ลองใช้ CodeTutor ACP ใน [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ให้เพิ่มสิ่งต่อไปนี้ใน Neovim ของคุณ:
...
- MCP แขกที่นี่คือข้อมูลเพิ่มเติมของ CodeTutor ของคุณ
