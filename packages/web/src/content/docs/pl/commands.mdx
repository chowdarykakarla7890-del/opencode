...
Utwórz `.codetutor/commands/test.md`:
...
Możesz zdefiniować polecenia w `codetutor.json` lub w plikach w katalogu `commands/`.
...
codetutor zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
