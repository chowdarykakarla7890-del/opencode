...
import type { AssistantMessage as CodeTutorAssistantMessage, Message } from "@opencode-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<CodeTutorAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<CodeTutorAssistantMessage, "role"> &
  Partial<Pick<CodeTutorAssistantMessage, "providerID" | "modelID">>
