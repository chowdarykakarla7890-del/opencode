...
declare const CODETUTOR_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof CODETUTOR_CLI_NAME === "string" ? CODETUTOR_CLI_NAME : "opencode", {
  description: "CodeTutor 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
