export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} CodeTutor je bila prenesena, jo želite namestiti in znova zagnati?",
