---
title: Zen
description: قائمة منتقاة من النماذج يوفّرها CodeTutor.
---
...
OpenCode Zen هي قائمة بالنماذج التي اختبرها فريق CodeTutor وتحقّق منها.

يعمل Zen مثل أي مزوّد آخر في CodeTutor. تسجّل الدخول إلى OpenCode Zen وتحصل على
مفتاح API. استخدامه **اختياري بالكامل** ولا تحتاج إليه لاستخدام CodeTutor.
...
:::tip
اختبرنا مجموعة منتقاة من النماذج والمزوّدين الذين يعملون جيدا مع CodeTutor.
:::
...
يعمل OpenCode Zen مثل أي مزوّد آخر في CodeTutor.
...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات CodeTutor الصيغة `opencode/<model-id>`. على سبيل المثال، بالنسبة إلى GPT 5.5، ستستخدم `opencode/gpt-5.5` في إعداداتك.
...
قد تلاحظ [نماذج منخفضة التكلفة](/docs/config/#models)، مثل Haiku أو Nano أو Flash، في سجل الاستخدام. يستخدم CodeTutor هذه النماذج لإنشاء عناوين الجلسات.
...
- DeepSeek V4 Flash Free متاح على CodeTutor لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- MiMo-V2.5 Free متاح على CodeTutor لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Hy3 Free متاح على CodeTutor لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Laguna S 2.1 Free متاح على CodeTutor لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Nemotron 3 Ultra Free متاح على CodeTutor لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Nemotron 3.5 Lightning Free متاح على CodeTutor لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Big Pickle نموذج خفي ومتاح مجانا على CodeTutor لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
...
4. **عدم فرض أي ارتباط حصري** عبر تمكينك من استخدامه مع أي عامل برمجة آخر. ومع إبقاء إمكانية استخدام أي مزوّد آخر مع CodeTutor أيضا دائما.
