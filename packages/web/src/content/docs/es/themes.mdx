...
Con CodeTutor puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, CodeTutor usa nuestro propio tema `codetutor`.
...
CodeTutor viene con varios temas integrados.
...
- Quiere que CodeTutor coincida con la apariencia de su terminal
...
CodeTutor admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
3. **Directorio raíz del proyecto**: definido en `<project-root>/.codetutor/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.codetutor/themes/*.json`
