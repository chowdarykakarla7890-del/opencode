export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van CodeTutor is gedownload. Wil je deze installeren en CodeTutor opnieuw starten?",
