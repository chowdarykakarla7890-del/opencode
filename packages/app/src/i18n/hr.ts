...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "CodeTutor se nije uspio učitati",
  "Prozor aplikacije CodeTutor neočekivano je zatvoren",
  "CodeTutor ne reagira",
  ...
  "Instalacija aplikacije CodeTutor nije uspjela",
  ...
  "CodeTutor nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije CodeTutor je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.codetutor.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.codetutor.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.codetutorGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Posjetiti",
  "provider.connect.codetutorZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u CodeTutor.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u codetutor.json",
  ...
  "dialog.server.description": "Promijenite na koji se CodeTutor poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera CodeTutor u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje CodeTutor u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte CodeTutor u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor je spreman u {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte CodeTutor u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte CodeTutor",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što CodeTutor može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite CodeTutor.",
  ...
  "help.tabs.introduction": "Radna površina CodeTutor sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija CodeTutor ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku CodeTutor timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (codetutor.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, CodeTutor još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "CodeTutor Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite CodeTutor poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za CodeTutor",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako CodeTutor izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li CodeTutor slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je CodeTutor tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se CodeTutor pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju CodeTutor.",
