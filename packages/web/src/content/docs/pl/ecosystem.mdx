---
title: Ekosystem
description: Projekty i integracje zbudowane przy użyciu CodeTutor.
---

Zbiór projektów społeczności zbudowanych na CodeTutor.

:::note
Chcesz dodać swój projekt związany z CodeTutor do tej listy? Prześlij PR.
:::
...
| Nazwa                                                                                              | Opis                                                                                                                  |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatyczne uruchamianie sesji CodeTutor w izolowanych piaskownicach Daytona z synchronizacją git i podglądem na żywo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Śledź użycie CodeTutor za pomocą Wakatime                                                                              |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Powiadomienia na pulpicie i alerty dźwiękowe dla sesji CodeTutor                                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Automatyczne nazywanie sesji Zellij oparte na AI w oparciu o kontekst CodeTutor                                        |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Pozwól agentom CodeTutor na leniwe ładowanie promptów na żądanie z odkrywaniem umiejętności i wstrzykiwaniem           |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Rozszerz komendy /commands CodeTutor w potężny system orkiestracji ze szczegółową kontrolą przepływu                   |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Natywne powiadomienia systemowe dla CodeTutor – wiedz, kiedy zadania się zakończą                                      |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Bezproblemowe drzewa robocze git dla CodeTutor                                                                         |
...
| Nazwa                                                                                      | Opis                                                                    |
| ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord do sterowania sesjami CodeTutor, zbudowany na SDK            |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Wtyczka Neovim dla promptów świadomych edytora, zbudowana na API        |
| [portal](https://github.com/hosenur/portal)                                                | Interfejs webowy mobile-first dla CodeTutor przez Tailscale/VPN          |
| [codetutor plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Szablon do tworzenia wtyczek CodeTutor                                   |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim dla CodeTutor - terminalowy agent kodujący AI            |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Dostawca Vercel AI SDK do używania CodeTutor przez @opencode-ai/sdk      |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplikacja Web / Desktop i rozszerzenie VS Code dla CodeTutor             |
| [CodeTutor-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Wtyczka Obsidian osadzająca CodeTutor w interfejsie Obsidian             |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Otwartoźródłowa alternatywa dla Claude Cowork, napędzana przez CodeTutor |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Menedżer rozszerzeń CodeTutor z przenośnymi, izolowanymi profilami.      |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplikacja kliencka Desktop, Web, Mobile i Remote dla CodeTutor           |
