export const dict = {
  ...
  "dialog.provider.codetutor.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.codetutor.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.codetutorGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Visita ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in CodeTutor.",
  ...
  "dialog.plugins.empty": "Plugin configurati in codetutor.json",
  ...
  "dialog.server.description": "Cambia il server CodeTutor a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo CodeTutor in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento CodeTutor in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna CodeTutor in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor è pronto in {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa CodeTutor in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che CodeTutor possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di CodeTutor ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team CodeTutor",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (codetutor.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: CodeTutor non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server CodeTutor all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per CodeTutor",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di CodeTutor sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se CodeTutor segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di CodeTutor.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di CodeTutor",
  ...
  "settings.updates.toast.latest.title": "CodeTutor è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di CodeTutor.",
  ...
  "desktop.menu.documentation": "Documentazione di CodeTutor",
  ...
  "desktop.menu.ariaLabel": "Menu CodeTutor",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare CodeTutor",
  "desktop.recovery.terminated": "La finestra di CodeTutor si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "CodeTutor non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di CodeTutor non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.codetutorMissing": "opencode non è installato in questa distribuzione",
  "desktop.wsl.error.codetutorCannotRun": "opencode è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di CodeTutor è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
