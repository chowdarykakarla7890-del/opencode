...
Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di codetutor come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.codetutor/tools/` del progetto.
