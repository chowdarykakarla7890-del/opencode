export const dict = {
  ...
  "desktop.menu.documentation": "CodeTutor Resminamalar",
  ...
  "desktop.menu.ariaLabel": "CodeTutor menýusy",
  ...
  "desktop.recovery.loadFailed": "CodeTutor ýükläp bilmedi",
  "desktop.recovery.terminated": "CodeTutor penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "CodeTutor jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutor gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.codetutorMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.codetutorCannotRun": "opencode guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "CodeTutor täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.codetutor.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.codetutorGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "CodeTutor tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we CodeTutor-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Sapar ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini CodeTutor-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini CodeTutor-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "codetutor.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy CodeTutor serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "CodeTutor barlamak ...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde CodeTutor barlanýar...",
  "wsl.onboarding.updatingOpencode": "CodeTutor täzelenmek ...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de CodeTutor täzelenmek ...",
  "wsl.onboarding.updateOpencodeIn": "CodeTutor-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "CodeTutor täzeläň",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor {{distro}}-de taýýar.",
  "wsl.onboarding.codetutorReady": "CodeTutor taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de CodeTutor guruň.",
  "wsl.onboarding.installOpencode": "CodeTutor guruň",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) CodeTutor WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra CodeTutor açyň.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin CodeTutor ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy CodeTutor toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (codetutor.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, CodeTutor entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "CodeTutor serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "CodeTutor üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "CodeTutor enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "CodeTutor ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "CodeTutor-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "CodeTutor işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "CodeTutor-iň iň soňky wersiýasyny işleýärsiňiz.",
