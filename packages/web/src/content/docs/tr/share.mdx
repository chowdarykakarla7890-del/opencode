---
title: Paylasim
description: codetutor konusmalarini genel baglantilarla paylasin.
---
...
Varsayilan olarak codetutor manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `codetutor.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda codetutor kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
