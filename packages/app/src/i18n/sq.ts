export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni CodeTutor",
  ...
  "desktop.menu.ariaLabel": "Menuja CodeTutor",
  ...
  "desktop.recovery.loadFailed": "CodeTutor nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja CodeTutor u mbyll papritur",
  "desktop.recovery.unresponsive": "CodeTutor nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i CodeTutor dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.codetutorMissing": "Opencode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.codetutorCannotRun": "Opencode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i CodeTutor përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.codetutor.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.codetutorGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Vizitoni ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në CodeTutor.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në codetutor.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server CodeTutor lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon CodeTutor në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "CodeTutor po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson CodeTutor në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso CodeTutor në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor është gati në {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni CodeTutor në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se CodeTutor të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i CodeTutor ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i CodeTutor",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (codetutor.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, CodeTutor nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin CodeTutor brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për CodeTutor",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket CodeTutor në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse CodeTutor ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e CodeTutor.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset CodeTutor",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të CodeTutor.",
