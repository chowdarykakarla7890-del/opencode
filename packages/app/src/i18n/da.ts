export const dict = {
  ...
  "dialog.provider.codetutor.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.codetutor.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.codetutorGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Besøg ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i CodeTutor.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i codetutor.json",
  ...
  "dialog.server.description": "Skift hvilken CodeTutor-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker CodeTutor i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer CodeTutor i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater CodeTutor i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før CodeTutor kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter CodeTutor igen.",
  ...
  "toast.update.description": "En ny version af CodeTutor ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til CodeTutor-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (codetutor.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, CodeTutor understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør CodeTutor-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for CodeTutor",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan CodeTutor ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om CodeTutor skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas CodeTutors tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CodeTutor starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CodeTutor.",
  ...
  "desktop.recovery.loadFailed": "CodeTutor kunne ikke indlæses",
  "desktop.recovery.terminated": "CodeTutor-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af CodeTutor mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.codetutorMissing": "opencode er ikke installeret i denne distribution",
  "desktop.wsl.error.codetutorCannotRun": "opencode er installeret, men kunne ikke køre",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af CodeTutor er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "CodeTutor Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
