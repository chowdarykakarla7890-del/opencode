...
Las herramientas personalizadas son funciones que usted crea y que el LLM puede llamar durante las conversaciones. Trabajan junto con las [herramientas integradas](/docs/tools) de codetutor como `read`, `write` y `bash`.
...
- Localmente colocándolos en el directorio `.codetutor/tools/` de tu proyecto.
