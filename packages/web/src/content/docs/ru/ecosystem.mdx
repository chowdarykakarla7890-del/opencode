---
title: Экосистема
description: Проекты и интеграции, созданные с помощью CodeTutor.
---

Коллекция проектов сообщества, построенных на CodeTutor.

:::note
Хотите добавить свой проект, связанный с CodeTutor, в этот список? Разместите PR.
:::
...
| Имя                                                                                                | Описание                                                                                                                                         |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Автоматически запускайте сеансы CodeTutor в изолированных песочницах Daytona с синхронизацией git и предварительным просмотром в реальном времени |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Отслеживайте использование CodeTutor с помощью Wakatime                                                                                           |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Уведомления на рабочем столе и звуковые оповещения для сеансов CodeTutor                                                                          |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Автоматическое именование сеансов Zellij на основе искусственного интеллекта на основе контекста CodeTutor                                        |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Разрешить агентам CodeTutor отложенную загрузку подсказок по требованию с обнаружением и внедрением навыков                                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Встроенные уведомления ОС для CodeTutor – узнайте, когда задачи завершены                                                                         |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Рабочие деревья git с нулевым трением для CodeTutor                                                                                               |
...
| Имя                                                                                        | Описание                                                                                      |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-бот для управления сеансами CodeTutor, созданный на базе SDK                           |
...
| [portal](https://github.com/hosenur/portal)                                                | Мобильный веб-интерфейс для CodeTutor через Tailscale/VPN                                      |
| [codetutor plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Шаблон для создания плагинов CodeTutor                                                         |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Интерфейс Neovim для CodeTutor - агент кодирования искусственного интеллекта на базе терминала |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Поставщик Vercel AI SDK для использования CodeTutor через @opencode-ai/sdk                     |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Веб-приложение или настольное приложение и расширение VS Code для CodeTutor                    |
| [CodeTutor-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Плагин Obsidian, встраивающий CodeTutor в пользовательский интерфейс Obsidian                  |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Альтернатива Claude Cowork с открытым исходным кодом на базе CodeTutor                         |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Менеджер расширений CodeTutor с переносимыми изолированными профилями                          |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Настольное, веб-, мобильное и удаленное клиентское приложение для CodeTutor                    |
