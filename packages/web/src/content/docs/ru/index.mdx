...
Вы также можете получить бинарный файл в разделе [Releases](https://github.com/chowdarykakarla7890-del/opencode/releases).
...
1. Запустите команду `/connect` в TUI, выберите opencode и перейдите по адресу [codetutor-docs.vercel.app/auth](https://codetutor-docs.vercel.app/auth).
...
Вот [пример диалога](https://codetutor-docs.vercel.app/s/4XP1fce5) с opencode.
...
Чтобы создать свою собственную, мы рекомендуем [выбрать тему](/docs/themes), [настроить привязки клавиш](/docs/keybinds), [настроить средства форматирования кода](/docs/formatters), [создать собственные команды](/docs/commands) или поиграться с файлом [codetutor config](/docs/config).
