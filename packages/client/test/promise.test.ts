...
import { isSessionNotFoundError, isUnauthorizedError, CodeTutor } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = CodeTutor.make({ baseUrl: "http://localhost:3000" })
