export const dict = {
  ...
  "desktop.menu.documentation": "CodeTutor Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "CodeTutor ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno CodeTutor se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "CodeTutor se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev CodeTutor ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.codetutorMissing": "opencode ni nameščen v tej distribuciji",
  "desktop.wsl.error.codetutorCannotRun": "opencode je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev CodeTutor je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.codetutor.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.codetutorGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Obisk ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v CodeTutor.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v codetutor.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom CodeTutor se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje CodeTutor ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje CodeTutor v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje CodeTutor ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje CodeTutor v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite CodeTutor v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor je pripravljen v {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite CodeTutor v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko CodeTutor doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica CodeTutor ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi CodeTutor",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (codetutor.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, CodeTutor še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik CodeTutor znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za CodeTutor",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako CodeTutor izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali CodeTutor sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo CodeTutor.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene CodeTutor",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico CodeTutor.",
