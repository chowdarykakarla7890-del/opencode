---
title: Zen
description: Kuratierte Modellliste direkt von CodeTutor.
---
...
OpenCode Zen ist eine Liste von getesteten und verifizierten Modellen, die vom CodeTutor-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in CodeTutor. Du meldest dich bei OpenCode Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um CodeTutor zu nutzen.
...
OpenCode Zen funktioniert wie jeder andere Provider in CodeTutor.
...
Die [Model-ID](/docs/config/#models) in deiner CodeTutor-Konfiguration verwendet das Format `opencode/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `opencode/gpt-5.5` in deiner Konfiguration verwenden.
...
Möglicherweise siehst du [kostengünstige Modelle](/docs/config/#models) wie Haiku, Nano oder Flash in deinem Nutzungsverlauf. CodeTutor verwendet diese Modelle, um Session-Titel zu generieren.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf CodeTutor verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf CodeTutor verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Hy3 Free ist für begrenzte Zeit auf CodeTutor verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Laguna S 2.1 Free ist für begrenzte Zeit auf CodeTutor verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf CodeTutor verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3.5 Lightning Free ist für begrenzte Zeit auf CodeTutor verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf CodeTutor verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit CodeTutor auch jeden anderen Provider zu verwenden.
