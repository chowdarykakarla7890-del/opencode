export const dict = {
  ...
  "desktop.recovery.loadFailed": "CodeTutor gagal dimuat",
  "desktop.recovery.terminated": "Jendela CodeTutor berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "CodeTutor tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi CodeTutor gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.codetutorMissing": "opencode belum terinstal di distro ini",
  "desktop.wsl.error.codetutorCannotRun": "opencode telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan CodeTutor selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.codetutor.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.codetutorGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di CodeTutor.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di codetutor.json",
  ...
  "dialog.server.description": "Ganti server CodeTutor mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa CodeTutor di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui CodeTutor di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui CodeTutor di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor siap di {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor siap.",
  "wsl.onboarding.installOpencodeIn": "Instal CodeTutor di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum CodeTutor dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru CodeTutor ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim CodeTutor",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (codetutor.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: CodeTutor belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server CodeTutor di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk CodeTutor",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan CodeTutor di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah CodeTutor mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat CodeTutor diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru CodeTutor.",
