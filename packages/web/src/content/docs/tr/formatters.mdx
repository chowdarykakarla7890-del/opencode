...
description: codetutor dile özgü biçimlendiriciler kullanır.
---
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, codetutor bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

codetutor bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri codetutor yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
