export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i CodeTutor është shkarkuar, dëshironi ta instaloni dhe rinisni?",
