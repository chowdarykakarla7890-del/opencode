export const dict = {
  ...
  "desktop.menu.documentation": "Documentație CodeTutor",
  ...
  "desktop.menu.ariaLabel": "Meniu CodeTutor",
  ...
  "desktop.recovery.loadFailed": "CodeTutor nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra CodeTutor s-a închis neașteptat",
  "desktop.recovery.unresponsive": "CodeTutor nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea CodeTutor a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.codetutorMissing": "opencode nu este instalat în această distribuție",
  "desktop.wsl.error.codetutorCannotRun": "opencode este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea CodeTutor s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.codetutor.tagline": "Modele optimizate, fiabile",
  "dialog.provider.codetutorGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Vizitează",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în CodeTutor.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în codetutor.json",
  ...
  "dialog.server.description": "Schimbă serverul CodeTutor la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică CodeTutor în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează CodeTutor în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează CodeTutor în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor este gata în {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează CodeTutor în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca CodeTutor să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune CodeTutor ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei CodeTutor",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (codetutor.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, CodeTutor nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul CodeTutor în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru CodeTutor",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul CodeTutor pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă CodeTutor urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema CodeTutor.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea CodeTutor",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune CodeTutor.",
