...
brew install anomalyco/tap/codetutor # macOS og Linux (anbefalt, alltid oppdatert)
brew install codetutor              # macOS og Linux (offisiell brew-formel, oppdateres sjeldnere)
...
CodeTutor er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/chowdarykakarla7890-del/opencode/releases) eller [codetutor.ai/download](https://github.com/chowdarykakarla7890-del/opencode/releases).
...
1. `$CODETUTOR_INSTALL_DIR` - Egendefinert installasjonsmappe
...
CodeTutor har to innebygde agents du kan bytte mellom med `Tab`-tasten.
...
Les mer om [agents](https://codetutor-docs.vercel.app/docs/agents).

### Dokumentasjon

For mer info om hvordan du konfigurerer CodeTutor, [**se dokumentasjonen**](https://codetutor-docs.vercel.app/docs).

### Bidra

Hvis du vil bidra til CodeTutor, les [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygge på CodeTutor

Hvis du jobber med et prosjekt som er relatert til CodeTutor og bruker "codetutor" som en del av navnet; for eksempel "codetutor-dashboard" eller "codetutor-mobile", legg inn en merknad i README som presiserer at det ikke er bygget av CodeTutor-teamet og ikke er tilknyttet oss på noen måte.

---

**Bli med i fellesskapet** [Discord](https://discord.gg/codetutor) | [X.com](https://x.com/codetutor)
