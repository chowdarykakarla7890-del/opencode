...
const releaseId = process.env.CODETUTOR_RELEASE
if (!releaseId) throw new Error("CODETUTOR_RELEASE is required")

const version = process.env.CODETUTOR_VERSION
if (!version) throw new Error("CODETUTOR_VERSION is required")
