...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "CodeTutor įkelti nepavyko",
  "CodeTutor langas netikėtai užsidarė",
  "CodeTutor neatsako",
  ...
  "CodeTutor įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "CodeTutor neįdiegtas distributyve {{distro}}",
  "CodeTutor naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.codetutor.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.codetutor.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.codetutorGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami CodeTutor modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Aplankykite",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius CodeTutor.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti codetutor.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio CodeTutor serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama CodeTutor {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas CodeTutor {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite CodeTutor {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor yra paruoštas {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite CodeTutor į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad CodeTutor galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują CodeTutor ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą CodeTutor komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (codetutor.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad CodeTutor dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "CodeTutor apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "CodeTutor darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite CodeTutor serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite CodeTutor ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip CodeTutor atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar CodeTutor seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite CodeTutor temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas CodeTutor",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią CodeTutor versiją.",
