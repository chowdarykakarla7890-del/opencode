...
Erstellen Sie `.codetutor/commands/test.md`:

```md title=".codetutor/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die CodeTutor-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem CodeTutor [config](/docs/config):

```json title="codetutor.jsonc" {4-12}
{
...
- Pro Projekt: `.codetutor/commands/`
...
```md title=".codetutor/commands/component.md"
---
...
```md title=".codetutor/commands/create-file.md"
---
...
```md title=".codetutor/commands/analyze-coverage.md"
---
...
```md title=".codetutor/commands/review-changes.md"
---
...
```md title=".codetutor/commands/review-component.md"
---
...
CodeTutor enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
