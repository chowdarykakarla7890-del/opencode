export const dict = {
  ...
  "desktop.recovery.loadFailed": "CodeTutorを読み込めませんでした",
  "desktop.recovery.terminated": "CodeTutorのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "CodeTutorが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutorのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.codetutorMissing": "このディストリビューションにはopencodeがインストールされていません",
  "desktop.wsl.error.codetutorCannotRun": "opencodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.codetutorNotInstalled": "{{distro}}にはCodeTutorがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "CodeTutorのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.codetutor.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.codetutor.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.codetutorGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "CodeTutorが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、CodeTutorで{{provider}}モデルを使用します。",
  ...
  "provider.connect.codetutorZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.codetutorZen.visit.prefix": " ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCodeTutorで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、CodeTutorで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "codetutor.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するCodeTutorサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "CodeTutorを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のCodeTutorを確認中...",
  "wsl.onboarding.updatingOpencode": "CodeTutorを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のCodeTutorを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のCodeTutorを更新してください。",
  "wsl.onboarding.updateOpencode": "CodeTutorを更新",
  "wsl.onboarding.codetutorReadyIn": "{{distro}}内のCodeTutorの準備ができました。",
  "wsl.onboarding.codetutorReady": "CodeTutorの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にCodeTutorをインストールしてください。",
  "wsl.onboarding.installOpencode": "CodeTutorをインストール",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutorがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CodeTutorでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、CodeTutorをもう一度開いてください。",
  ...
  "help.tabs.introduction": "CodeTutor Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CodeTutorの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをCodeTutorチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (codetutor.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: CodeTutorはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "CodeTutorには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でCodeTutorサーバーを実行します。",
  ...
  "settings.general.row.language.description": "CodeTutorの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのCodeTutorの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "CodeTutorがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "CodeTutorのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "CodeTutor の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "CodeTutor は最新バージョンです。",
