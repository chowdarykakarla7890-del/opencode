---
title: Écosystème
description: Projets et intégrations construits avec CodeTutor.
---

Une collection de projets communautaires construits sur CodeTutor.

:::note
Vous souhaitez ajouter votre projet lié à CodeTutor à cette liste ? Soumettez une PR.
:::
...
| Nom                                                                                                | Description                                                                                                                            |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Exécute automatiquement des sessions CodeTutor dans des sandbox Daytona isolées avec synchronisation git et prévisualisations en direct |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Suit l'utilisation d'CodeTutor avec Wakatime                                                                                            |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifications de bureau et alertes sonores pour les sessions CodeTutor                                                                  |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nommage automatique de session Zellij alimenté par l'IA basé sur le contexte CodeTutor                                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permet aux agents CodeTutor le chargement différé de prompts à la demande avec découverte et injection de compétences                   |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifications natives de l'OS pour CodeTutor – sachez quand les tâches sont terminées                                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sans friction pour CodeTutor                                                                                              |
...
| Nom                                                                                        | Description                                                                 |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord pour contrôler les sessions CodeTutor, construit sur le SDK      |
...
| [portal](https://github.com/hosenur/portal)                                                | Interface Web mobile-first pour CodeTutor via Tailscale/VPN                  |
| [codetutor plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Modèle pour créer des plugins CodeTutor                                      |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Fournisseur Vercel AI SDK pour utiliser CodeTutor via @opencode-ai/sdk       |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Application Web / Bureau et extension VS Code pour CodeTutor                 |
| [CodeTutor-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian qui intègre CodeTutor dans l'interface d'Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Une alternative open-source à Claude Cowork, propulsée par CodeTutor         |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestionnaire d'extensions CodeTutor avec profils portables et isolés.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Application client Bureau, Web, Mobile et Distante pour CodeTutor            |
