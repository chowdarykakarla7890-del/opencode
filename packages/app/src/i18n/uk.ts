export const dict = {
  ...
  "desktop.menu.documentation": "Документація CodeTutor",
  ...
  "desktop.menu.ariaLabel": "Меню CodeTutor",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити CodeTutor",
  "desktop.recovery.terminated": "Роботу вікна CodeTutor несподівано завершено",
  "desktop.recovery.unresponsive": "CodeTutor не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити CodeTutor",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.codetutorMissing": "opencode не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.codetutorCannotRun": "opencode встановлено, але його не вдалося запустити",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення CodeTutor завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.codetutor.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.codetutorGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Відвідайте ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у CodeTutor.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в codetutor.json",
  ...
  "dialog.server.description": "Перемкніть сервер CodeTutor, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка CodeTutor у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення CodeTutor у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть CodeTutor у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor готовий до роботи у {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть CodeTutor у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в CodeTutor потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія CodeTutor ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді CodeTutor",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (codetutor.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, CodeTutor ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер CodeTutor всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу CodeTutor",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд CodeTutor на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи CodeTutor використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему CodeTutor.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску CodeTutor",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію CodeTutor.",
