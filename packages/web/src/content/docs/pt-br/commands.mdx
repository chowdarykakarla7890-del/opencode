...
Crie `.codetutor/commands/test.md`:
...
Você pode adicionar comandos personalizados através da configuração do codetutor ou criando arquivos markdown no diretório `commands/`.
...
- Por projeto: `.codetutor/commands/`
...
codetutor inclui vários comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [saiba mais](/docs/tui#commands).
