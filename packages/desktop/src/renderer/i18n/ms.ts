export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} CodeTutor telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
