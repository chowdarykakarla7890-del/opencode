export const dict = {
  ...
  "desktop.recovery.loadFailed": "CodeTutor laadimine ebaõnnestus",
  "desktop.recovery.terminated": "CodeTutor aken suleti ootamatult",
  "desktop.recovery.unresponsive": "CodeTutor ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutor installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.codetutorMissing": "opencode pole sellesse distrosse installitud",
  "desktop.wsl.error.codetutorCannotRun": "opencode on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CodeTutor värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.codetutor.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.codetutorGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid CodeTutor'is.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Külastage ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises CodeTutor.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis codetutor.json",
  ...
  "dialog.server.description": "Lülitage, millise CodeTutor serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "CodeTutor kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "CodeTutor kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "CodeTutor värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "CodeTutor värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda CodeTutor jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor on valmis {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige CodeTutor asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui CodeTutor saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse CodeTutor ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast CodeTutor meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (codetutor.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, CodeTutor ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "CodeTutor Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage CodeTutor server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke CodeTutor kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas CodeTutor teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas CodeTutor järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas CodeTutor on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui CodeTutor käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse CodeTutor uusimat versiooni.",
