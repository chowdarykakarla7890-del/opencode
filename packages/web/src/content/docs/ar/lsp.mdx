---
title: خوادم LSP
description: يتكامل CodeTutor مع خوادم LSP لديك.
---

يمكن أن يتكامل CodeTutor مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي CodeTutor مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `CODETUTOR_DISABLE_LSP_DOWNLOAD` على `true`.
:::
