---
title: TUI
description: Korištenje korisničkog interfejsa CodeTutor terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodeTutor pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje CodeTutor pokreće TUI za trenutni direktorij.
...
Kada koristite CodeTutor TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u CodeTutor. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz CodeTutor. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `codetutor.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo CodeTutor čeka nakon leader key. Podrazumijevano je `2000`.
