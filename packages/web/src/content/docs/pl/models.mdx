...
codetutor używa [AI SDK](https://ai-sdk.dev/) i [Models.dev](https://models.dev) do obsługi **ponad 75 dostawców LLM** i obsługi uruchamiania modeli pierwszych.
...
Wiele modeli obsługuje wiele wariantów lub różnych wybranych. codetutor jest dostarczany z podstawowymi wariantami wariantów dla dostawców.

### Wbudowane warianty

codetutor jest dostarczany z domyślnymi wariantami dla wielu dostawców:
...
Po uruchomieniu codetutor sprawdzanie modeli w następującej kolejności:
