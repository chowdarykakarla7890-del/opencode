export const dict = {
  ...
  "desktop.menu.documentation": "CodeTutor-documentatie",
  ...
  "desktop.recovery.loadFailed": "CodeTutor kan niet worden geladen",
  "desktop.recovery.terminated": "Het CodeTutor-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "CodeTutor reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van CodeTutor is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.codetutorMissing": "opencode is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.codetutorCannotRun": "opencode is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De CodeTutor-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.codetutor.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.codetutorGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in CodeTutor te gebruiken.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Ga naar ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in CodeTutor te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in CodeTutor te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in codetutor.json",
  ...
  "dialog.server.description": "Wijzig met welke CodeTutor-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "CodeTutor controleren...",
  "wsl.onboarding.checkingOpencodeIn": "CodeTutor controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "CodeTutor bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "CodeTutor bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk CodeTutor bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "CodeTutor bijwerken",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor is gereed in {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer CodeTutor in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat CodeTutor een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens CodeTutor opnieuw.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van CodeTutor ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het CodeTutor-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (codetutor.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: CodeTutor ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de CodeTutor-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor CodeTutor",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe CodeTutor eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of CodeTutor het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van CodeTutor aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer CodeTutor wordt gestart",
  ...
  "settings.updates.toast.latest.title": "CodeTutor is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van CodeTutor.",
