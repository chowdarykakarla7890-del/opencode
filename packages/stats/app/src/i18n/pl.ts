export const dict = {
  "app.title": "Rankingi użycia modeli AI | CodeTutor Data",
  "app.description":
    "Przeglądaj użycie CodeTutor Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny CodeTutor Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę CodeTutor na GitHub",
  "header.github": "GitHub",
  "header.tryCodeTutor": "Wypróbuj CodeTutor",
  ...
  "footer.homeAria": "Strona główna CodeTutor",
  ...
  "home.topModelsDescription": "Użycie modeli w CodeTutor Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy CodeTutor Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | CodeTutor Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w CodeTutor Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia CodeTutor.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w CodeTutor",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia CodeTutor",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów CodeTutor z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | CodeTutor Data",
  "model.description":
    "Zobacz dane użycia {{model}} w CodeTutor Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie CodeTutor Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu CodeTutor Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu CodeTutor Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia CodeTutor Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny CodeTutor Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia CodeTutor Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów CodeTutor Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy CodeTutor Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji CodeTutor Go.",
  ...
  "model.geoDescription": "Tokeny modelu CodeTutor Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne CodeTutor Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów CodeTutor Go.",
