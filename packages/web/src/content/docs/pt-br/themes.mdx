...
Por padrão, o codetutor usa nosso próprio tema `codetutor`.
...
O codetutor vem com vários temas embutidos.
...
- Querem que o codetutor corresponda à aparência do seu terminal
...
O codetutor suporta um sistema de temas flexível baseado em JSON que permite aos usuários criar e personalizar temas facilmente.
...
3. **Diretório raiz do projeto** - Definido em `<project-root>/.codetutor/themes/*.json`
4. **Diretório de trabalho atual** - Definido em `./.codetutor/themes/*.json`
