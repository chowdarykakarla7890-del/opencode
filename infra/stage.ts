export const domain = (() => {
  if ($app.stage === "production") return "codetutor-docs.vercel.app"
  if ($app.stage === "dev") return "dev.codetutor.ai"
  return `${$app.stage}.dev.codetutor.ai`
})()
...
if ($app.stage === "production") {
  ...
  new cloudflare.DnsRecord("TrustCenterVerification", {
    zoneId: zoneID,
    name: "codetutor-docs.vercel.app",
    type: "TXT",
