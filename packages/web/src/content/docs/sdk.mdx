---
title: SDK
description: Type-safe JS client for codetutor server.
---
...
Use it to build integrations and control codetutor programmatically.
...
You can pass a configuration object to customize behavior. The instance still picks up your `codetutor.json`, but you can override or add configuration inline:
