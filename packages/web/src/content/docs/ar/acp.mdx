---
title: دعم ACP
description: استخدم CodeTutor في أي محرر متوافق مع ACP.
---

يدعم CodeTutor بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام CodeTutor عبر ACP، اضبط محررك ليشغّل الأمر `codetutor acp`.

يشغّل هذا الأمر CodeTutor كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'CodeTutor' من محدد الوكلاء في AI Chat.
...
لاستخدام CodeTutor كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام CodeTutor كوكيل ACP للدردشة.
...
يعمل CodeTutor عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات CodeTutor
