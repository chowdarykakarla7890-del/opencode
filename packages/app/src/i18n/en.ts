...
export const dict = {
  ...
  "builder.home": "Sparkly home",
  "builder.navigation": "Primary navigation",
  "builder.projects": "Projects",
  "builder.templates": "Templates",
  "builder.account": "Account",
  "account.title": "CodeTutor account",
  "account.signedIn": "Signed in",
  "account.plan": "Plan",
  "account.models": "Managed models",
  "account.models.all": "All language models",
  "account.byok": "Personal providers",
  "account.managedAi": "Managed AI",
  "account.status": "Status",
  "account.available": "Available",
  "account.unavailable": "Unavailable",
  "account.currentPlan": "Current plan",
  "account.manageBilling": "Manage billing",
  "account.requestsRemaining": "Requests remaining",
  "account.tokensRemaining": "Tokens remaining",
  "account.creditRemaining": "Included AI credit remaining",
  "account.topupBalance": "Top-up balance",
  "account.starter.title": "Starter · $12/month",
  "account.starter.description": "5,000 requests · 20M tokens · $6 AI credit",
  "account.pro.title": "Pro · $29/month",
  "account.pro.description": "20,000 requests · 100M tokens · $18 AI credit",
  "account.buyCredit": "Buy AI credit",
  "account.credit": "credit",
  "account.signOut": "Sign out",
  "account.signIn.title": "Sign in to keep learning",
  "account.signIn.description": "Your repositories and tutor transcripts stay on this device. Sign in to use managed AI and sync profile, progress, preferences, usage, and billing.",
  "account.signIn.github": "Continue with GitHub",
  "account.signIn.google": "Continue with Google",
  "account.signIn.emailDivider": "or use email",
  "account.signIn.email": "Email",
  "account.signIn.emailAction": "Email me a sign-in link",
  "account.signIn.local": "Continue with local learning",
  "account.signIn.emailSent": "Check your email for the CodeTutor sign-in link.",
  "account.managedOnly": "Models are securely routed through CodeTutor Cloud and Vercel AI Gateway.",
  "account.profile": "Tutor profile",
  "account.learnerLevel": "Learner level",
  "account.sessions": "Signed-in devices",
  "account.session.current": "Current",
  "account.session.revoke": "Revoke",
  "account.session.none": "No device sessions found.",
  "builder.kicker": "PROMPT TO PRODUCT",
  "builder.title": "What will you make today?",
  "builder.subtitle": "Describe your idea and get a polished website or app in moments.",
  "builder.prompt.label": "Your idea",
  "builder.prompt.placeholder": "Describe the website or app you want to build...",
  "builder.prompt.hint": "Be as specific or as simple as you like",
  "builder.generate": "Generate",
  "builder.generating": "Building...",
  "builder.try": "Try an idea",
  "builder.example.store": "An online store for handmade ceramics",
  "builder.example.portfolio": "A minimal portfolio for a photographer",
  "builder.example.tracker": "A simple habit tracker",
  "builder.output.label": "YOUR APP",
  "builder.share": "Share",
  "builder.copied": "Copied",
  "builder.publish": "Publish",
  "builder.published": "Published",
  "builder.live": "Live preview",
  "builder.view": "App view",
  "builder.preview": "Preview",
  "builder.code": "Code",
  "builder.code.files": "Files",
  "builder.code.generated": "Generated",
  "builder.preview.today": "Today",
  "builder.preview.profile": "AM",
  "builder.preview.greeting": "MONDAY, JUNE 24",
  "builder.preview.heading": "Small steps, every day.",
  "builder.preview.progress": "Daily progress",
  "builder.preview.habit1": "Morning walk",
  "builder.preview.habit2": "Drink water",
  "builder.preview.habit3": "Read for 20 minutes",
  ...
  "dialog.provider.codetutor.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.codetutor.tagline": "Reliable optimized models",
  "dialog.provider.codetutorGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CodeTutor.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.codetutorZen.line1":
    "OpenCode Zen is an optional third-party provider with a curated set of coding models.",
  "provider.connect.codetutorZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.codetutorZen.visit.prefix": "Visit ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CodeTutor.",
  ...
  "model.tag.chatOnly": "Chat only",
  "model.tag.unavailable": "Unavailable",
  ...
  "dialog.plugins.empty": "Plugins configured in codetutor.json",
  ...
  "dialog.server.description": "Switch which CodeTutor server this app connects to.",
  ...
  "wsl.onboarding.step.codetutor": "CodeTutor",
  ...
  "wsl.onboarding.checkingOpencode": "Checking CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Checking CodeTutor in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Updating CodeTutor in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update CodeTutor in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor is ready in {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor is ready.",
  "wsl.onboarding.installOpencodeIn": "Install CodeTutor in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before CodeTutor can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of CodeTutor ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the CodeTutor team",
  ...
  "error.chain.checkConfig": "Check your config (codetutor.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CodeTutor does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor includes free models so you can start immediately.",
  ...
  "app.name.desktop": "CodeTutor Desktop",
  ...
  "settings.desktop.wsl.description": "Run the CodeTutor server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for CodeTutor",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how CodeTutor looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether CodeTutor follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CodeTutor is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CodeTutor launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of CodeTutor.",
  ...
  "learning.back": "← Back to projects",
  "learning.title": "Learn with CodeTutor",
  "learning.description": "Build coding skills in real workspaces with deterministic checks and an adaptive tutor.",
  "learning.level": "Teaching level",
  "learning.level.beginner": "Beginner",
  "learning.level.intermediate": "Intermediate",
  "learning.level.advanced": "Advanced",
  "learning.stats.completed": "Completed",
  "learning.stats.inProgress": "In progress",
  "learning.stats.tracks": "Tracks",
  "learning.minutes": "minutes",
  "learning.objectives": "Objectives",
  "learning.workspace": "Lesson workspace",
  "learning.start": "Start lesson",
  "learning.resume": "Resume lesson",
  "learning.check": "Run check",
  "learning.reset": "Reset",
  "learning.reset.confirm": "Reset this lesson and replace its workspace with the starter files?",
  "learning.action.started": "Lesson workspace is ready.",
  "learning.action.checked": "Deterministic check finished.",
  "learning.action.reset": "Lesson reset to its starter files.",
  "learning.action.levelUpdated": "Teaching level updated.",
  "learning.check.passed": "Check passed — lesson complete",
  "learning.check.failed": "Check failed — keep working",
}
