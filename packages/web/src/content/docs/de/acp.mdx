...
description: Verwenden Sie CodeTutor in jedem ACP-kompatiblen Editor.
---

CodeTutor unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um CodeTutor über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `codetutor acp`.

Der Befehl startet CodeTutor als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „CodeTutor“ in der AI Chat Agent Selector.
...
Um CodeTutor als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass CodeTutor als ACP-Agent für den Chat verwendet wird.
...
CodeTutor funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer CodeTutor-Konfiguration konfiguriert sind
