export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di CodeTutor",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di CodeTutor è stata scaricata. Vuoi installarla e riavviare l'app?",
