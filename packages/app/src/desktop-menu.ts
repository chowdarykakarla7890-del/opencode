...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    items: [
      { type: "item", labelKey: "desktop.menu.documentation", href: "https://codetutor-docs.vercel.app/docs" },
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/chowdarykakarla7890-del/opencode/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        labelKey: "desktop.menu.reportBug",
        href: "https://github.com/chowdarykakarla7890-del/opencode/issues/new?template=bug_report.yml",
      },
    ],
  },
]
