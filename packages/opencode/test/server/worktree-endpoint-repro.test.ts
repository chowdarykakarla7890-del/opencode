...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      CODETUTOR_EXPERIMENTAL_WORKSPACES: Flag.CODETUTOR_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.CODETUTOR_EXPERIMENTAL_WORKSPACES = original.CODETUTOR_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
