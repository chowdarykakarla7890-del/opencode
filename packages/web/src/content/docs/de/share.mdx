---
title: Teilen
description: Teile CodeTutor-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu CodeTutor-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht CodeTutor Folgendes:
...
CodeTutor hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt CodeTutor den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`codetutor.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du codetutor in deiner Organisation einsetzt.
