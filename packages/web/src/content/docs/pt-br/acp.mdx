---
title: Suporte ACP
description: Use o codetutor em qualquer editor compatível com ACP.
---

O codetutor suporta o [Agent Client Protocol](https://agentclientprotocol.com) ou (ACP), permitindo que você o utilize diretamente em editores e IDEs compatíveis.
...
Para usar codetutor via ACP, configure seu editor para executar o comando `codetutor acp`.

Este comando inicia o codetutor como um subprocesso compatível com ACP que se comunica com seu editor via JSON-RPC através do stdio.
...
Para usar codetutor como um agente ACP no [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), adicione o seguinte à sua configuração do Neovim:
...
Esta configuração configura o CodeCompanion para usar codetutor como o agente ACP para chat.
...
O codetutor funciona da mesma forma via ACP como funciona no terminal. Todos os recursos são suportados:
