...
export const dict = {
  ...
  "desktop.menu.documentation": "CodeTutor-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "CodeTutor-meny",
  ...
  "desktop.recovery.loadFailed": "CodeTutor kunne ikke lastes inn",
  "desktop.recovery.terminated": "CodeTutor-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "CodeTutor svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av CodeTutor mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.codetutorMissing": "opencode er ikke installert i denne distribusjonen",
  "desktop.wsl.error.codetutorCannotRun": "opencode er installert, men kunne ikke kjøres",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av CodeTutor er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.codetutor.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.codetutorGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Besøk ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i CodeTutor.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i codetutor.json",
  ...
  "dialog.server.description": "Bytt hvilken CodeTutor-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av CodeTutor ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til CodeTutor-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (codetutor.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at CodeTutor ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør CodeTutor-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for CodeTutor",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan CodeTutor ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om CodeTutor skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i CodeTutor.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når CodeTutor starter",
  ...
  "settings.updates.toast.latest.title": "CodeTutor er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av CodeTutor.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker CodeTutor i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer CodeTutor i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater CodeTutor i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor er klar i {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer CodeTutor i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før CodeTutor kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter CodeTutor på nytt.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
