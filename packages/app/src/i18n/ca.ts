export const dict = {
  ...
  "desktop.menu.documentation": "CodeTutor Documentació",
  ...
  "desktop.menu.ariaLabel": "menú CodeTutor.",
  ...
  "desktop.recovery.loadFailed": "CodeTutor no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra CodeTutor s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "CodeTutor no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de CodeTutor ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.codetutorMissing": "opencode no està instal·lat en aquesta distribució",
  "desktop.wsl.error.codetutorCannotRun": "opencode està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CodeTutor actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.codetutor.tagline": "Models optimitzats fiables",
  "dialog.provider.codetutorGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a CodeTutor.",
  ...
  "dialog.plugins.empty": "Connectors configurats a codetutor.json",
  ...
  "dialog.server.description": "Canvia a quin CodeTutor servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant CodeTutor a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant CodeTutor a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza CodeTutor a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor està llest a {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu CodeTutor a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que CodeTutor pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de CodeTutor ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip CodeTutor.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (codetutor.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que CodeTutor encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "CodeTutor Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor CodeTutor dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a CodeTutor",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu CodeTutor al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si CodeTutor segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de CodeTutor.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï CodeTutor.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de CodeTutor.",
