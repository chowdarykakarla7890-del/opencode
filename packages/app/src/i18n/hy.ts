export const dict = {
  ...
  "desktop.menu.documentation": "CodeTutor Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "CodeTutor մենյու",
  ...
  "desktop.recovery.loadFailed": "CodeTutor չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "CodeTutor պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "CodeTutor-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "CodeTutor տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.codetutorMissing": "opencode-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.codetutorCannotRun": "opencode-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CodeTutor թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.codetutor.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.codetutorGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և CodeTutor-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Այցելություն ",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և CodeTutor-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և CodeTutor-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են codetutor.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ CodeTutor սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է CodeTutor-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է CodeTutor-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել CodeTutor-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.codetutorReady": "CodeTutor պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք CodeTutor-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի CodeTutor-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք CodeTutor։",
  ...
  "help.tabs.introduction": "CodeTutor Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CodeTutor-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին CodeTutor թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (codetutor.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ CodeTutor-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "CodeTutor ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք CodeTutor սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն CodeTutor",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է CodeTutor տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ CodeTutor-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է CodeTutor-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ CodeTutor-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք CodeTutor-ի վերջին տարբերակը։",
