export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi CodeTutor",
  ...
  "desktop.recovery.loadFailed": "CodeTutor gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap CodeTutor ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "CodeTutor tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan CodeTutor gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.codetutorMissing": "opencode tidak dipasang dalam distro ini",
  "desktop.wsl.error.codetutorCannotRun": "opencode dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.codetutorNotInstalled": "CodeTutor tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini CodeTutor selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.codetutor.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.codetutor.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.codetutorGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh CodeTutor",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam CodeTutor.",
  ...
  "provider.connect.codetutorZen.visit.prefix": "Layari",
  "provider.connect.codetutorZen.visit.link": "opencode.ai/zen",
  "provider.connect.codetutorZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam CodeTutor.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam CodeTutor.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam codetutor.json",
  ...
  "dialog.server.description": "Tukar pelayan CodeTutor yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak CodeTutor...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak CodeTutor dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini CodeTutor...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini CodeTutor dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini CodeTutor dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini CodeTutor",
  "wsl.onboarding.codetutorReadyIn": "CodeTutor sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.codetutorReady": "CodeTutor sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang CodeTutor dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang CodeTutor",
  ...
  "wsl.onboarding.distroStatus.codetutorMissing": "CodeTutor belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum CodeTutor boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "CodeTutor tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula CodeTutor.",
  ...
  "help.tabs.introduction": "CodeTutor Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu CodeTutor ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan CodeTutor",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (codetutor.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, CodeTutor belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeTutor merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan CodeTutor dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk CodeTutor",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa CodeTutor pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada CodeTutor mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema CodeTutor.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila CodeTutor dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini CodeTutor.",
