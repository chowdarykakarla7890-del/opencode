export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju CodeTutor-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} CodeTutor-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
