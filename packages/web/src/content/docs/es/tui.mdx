---
title: TUI
description: Usando la interfaz de usuario del terminal CodeTutor.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodeTutor proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar CodeTutor se inicia TUI para el directorio actual.
...
Cuando utilice CodeTutor TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a CodeTutor. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de CodeTutor. _Alias_: `/quit`, `/q`
...
Esto es independiente de `codetutor.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera CodeTutor después de la leader key. El valor predeterminado es `2000`.
