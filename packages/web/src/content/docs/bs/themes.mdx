...
U CodeTutor mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, CodeTutor koristi nasu `codetutor` temu.
...
CodeTutor dolazi sa vise ugradenih tema.
...
- Zele da CodeTutor odgovara izgledu njihovog terminala
...
CodeTutor podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
...
3. **Korijenski direktorij projekta** - `<project-root>/.codetutor/themes/*.json`
4. **Trenutni radni direktorij** - `./.codetutor/themes/*.json`
